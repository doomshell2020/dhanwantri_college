...
<tr>
<td align="center" width="100%" >
<h3 style="font-size:16px; font-weight:400; line-height:15px;">
Cambridge Upper Secondary</h3></td></tr>
<tr>
<td align="center" width="100%" >
<h3 style="font-size:12px; font-weight:400; line-height:16px;">';

if($students['class_id']=='25') {
	$html.='GRADE : IGCSE YEAR I';

} else if($students['class_id']=='29') {
	$html.='GRADE : IGCSE YEAR II';
}
...
<tr>
<td align="center" width="100%">
<h4 style="font-size:12px; font-weight:400; line-height:15px;">
...
if($students['class_id']=='25') {
$html.='IGCSE Year I / '.ucwords(strtolower($fhosue['name']));

} else if($students['class_id']=='29') {
	$html.='IGCSE Year II / '.ucwords(strtolower($fhosue['name']));
}
...
$html.='<tr>
<td width="34%" style="border-top:1px solid #000; border-left:1px solid #000;  height:38px; line-height:38px;  border-right:1px solid #000;  font-weight:bold; " align="left">&nbsp;Subject Name & Subject code</td>
...
<td width="13%" style="border-top:1px solid #000;  font-weight:bold;  border-right:1px solid #000;" align="center">Total<br>(100 marks)</td>
<td width="8%" style="border-top:1px solid #000;  font-weight:bold; border-right:1px solid #000;" align="center">Grade</td>
</tr>';
...
$fg=array();
 ...
 foreach($subject as $key=>$name){ 
	 ...
	 if($name['id']=='212' || $name['id']=='213' || $name['id']=='221' || $name['id']=='222'){
		$name['exprint']="Hindi (0549) / French (0520)"; 
	 }else if($name['id']=='214' || $name['id']=='236'){
		$name['exprint']="Global Perspective (0457) /<br>  Economics (0455)"; 
	 }else if($name['id']=='218' || $name['id']=='219' || $name['id']=='227' || $name['id']=='228'){
		$name['exprint']="Art (0400) / Business Studies (0450)"; 
	 }else{
		$name['exprint']=$name['exprint'].' ('.$name['code'].')';
	 }
	
$html.='<tr>
<td width="34%" style="border-top:1px solid #000; border-left:1px solid #000; height:15px; line-height:15px; border-right:1px solid #000; font-weight:bold;" align="left">&nbsp; '.$name['exprint'].'</td>';
...
$html.='<td width="13%" style="border-top:1px solid #000;  border-right:1px solid #000; height:15px; line-height:15px;" align="center">'.$ter.'</td>
<td width="8%" style="border-top:1px solid #000; border-right:1px solid #000; height:15px; line-height:15px;" align="center">'.$ss.'</td>
</tr>';
$fgj+=$ter;
$bn+=$cn;
...
$html.='<tr>
<td width="79%" style="border-top:1px solid #000; border-left:1px solid #000; height:15px; line-height:15px; border-right:1px solid #000; border-bottom:1px solid #000; font-weight:bold;" align="left">&nbsp; Overall Marks & Grade</td>

<td width="13%" style="border-top:1px solid #000;  border-right:1px solid #000; height:15px; border-bottom:1px solid #000; line-height:15px;" align="center">'.$fgj.'</td>

<td width="8%" style="border-top:1px solid #000; border-right:1px solid #000; height:15px; border-bottom:1px solid #000; line-height:15px;" align="center">'.$ss1.'</td>
</tr>
