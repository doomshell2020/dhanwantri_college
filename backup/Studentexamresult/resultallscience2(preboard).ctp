...
<td width="36%" style="border-top:1px solid #000;  text-transform:uppercase; height:38px; line-height:20px;  font-weight:bold;  border-right:1px solid #000;" align="center" >&nbsp; SUBJECTS</td>
<td width="21%" style="border-top:1px solid #000;  text-transform:uppercase; height:38px; line-height:20px;  font-weight:bold;  border-right:1px solid #000;" align="center" >&nbsp; Pre Board 1</td>

<td width="31%" style="border-top:1px solid #000; font-weight:bold; border-right:1px solid #000; line-height:20px;" colspan="2"><table width="100%"><tr><td align="center" style="border-bottom:1px solid #000;" colspan="2">Pre Board 2 </td></tr><tr><td align="center" width="50%" style="border-right:1px solid #000; font-weight:bold; line-height:20px;border-right:1px solid #000;">TH</td><td align="center" style=" font-weight:bold; line-height:20px;">Pr</td></tr></table></td>
</tr>';
...
<td width="36%" style="border-top:1px solid #000; font-weight:bold;  border-right:1px solid #000; height:15px; line-height:15px;" align="center"> '.$name['exprint'].'</td>
<td width="21%" style="border-top:1px solid #000; border-right:1px solid #000; height:15px; line-height:15px;" align="center"></td>';
...
if($newmarks['marks']!=''){
		 $html.='<td width="15.5%" style="border-top:1px solid #000;  border-right:1px solid #000; height:15px; line-height:15px;" align="center">'.$newmarks['marks'].'</td>';
			 ...
			 $html.='<td width="15.5%" style="border-top:1px solid #000;  border-right:1px solid #000;height:15px; line-height:15px;" align="center">--</td>';
...
$html.='<tr style="font-size:12px;">
<td width="12%" style="border-top:1px solid #000; text-align:center; border-left:1px solid #000; height:15px; line-height:15px; border-right:1px solid #000;  " align="center">&nbsp;  '.$cnt++.'.</td>
<td width="36%" style="border-top:1px solid #000; font-weight:bold;  border-right:1px solid #000; height:15px; line-height:15px;" align="center"> '.$name2['exprint'].'</td>
<td width="21%" style="border-top:1px solid #000; border-right:1px solid #000; height:15px; line-height:15px;" align="center"></td>';
$cnt2++;
$ter=0;
$grade=0;
...
$html.='<tr style="font-size:12px;">
<td width="48%" style="border-top:1px solid #000; font-size:12px; border-left:1px solid #000; height:15px; line-height:15px; border-right:1px solid #000; text-align:center;   font-weight:bold;" colspan="2">TOTAL</td>
<td width="21%" style="border-top:1px solid #000;  border-right:1px solid #000; height:15px; line-height:15px;" align="center"></td>
<td width="31%" style="border-top:1px solid #000; border-right:1px solid #000; height:15px; line-height:15px;" align="center">'.$total.'</td>
</tr>
...
<td width="48%" style="border-top:1px solid #000; font-size:12px; border-left:1px solid #000; height:15px; line-height:15px; border-right:1px solid #000; text-align:center;  font-weight:bold;" colspan="2">TOTAL%</td>
<td width="21%" style="border-top:1px solid #000;  border-right:1px solid #000; height:15px; line-height:15px;" align="center"></td>
<td width="31%" style="border-top:1px solid #000; border-right:1px solid #000; height:15px; line-height:15px;" align="center">'.$gradestotal.'%</td>
</tr>


<tr style="font-size:12px;">
<td width="48%" style="border-top:1px solid #000; border-bottom:1px solid #000; font-size:12px; border-left:1px solid #000; height:15px; line-height:15px; border-right:1px solid #000; text-align:center;  font-weight:bold;" colspan="2">ATTENDANCE</td>
<td width="21%" style="border-top:1px solid #000; border-bottom:1px solid #000;  border-right:1px solid #000; height:15px; line-height:15px;" align="center"></td>
<td width="31%" style="border-top:1px solid #000; border-bottom:1px solid #000; border-right:1px solid #000; height:15px; line-height:15px;" align="center">'.$daysAttended.'/'.$WorkingDays.'</td>
</tr>
