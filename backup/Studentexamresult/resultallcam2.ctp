...
<h2 style="font-size:18px; font-weight:400; text-align:center;">
Report Card</h2>
</td></tr>
<tr>
<td align="center" width="100%" >
<h3 style="font-size:17px; font-weight:400; text-align:center;">
Final Term</h3>
</td></tr>
<tr>
<td align="center" width="100%" >';
if($students['class_id']=='23') {
	$stag='(STAGE-7)';
$html.='<h3 style="font-size:16px; font-weight:400;">
...
GRADE : '.substr($classt['title'],0, -3).' CAMBRIDGE '.$stag.'</h3></td></tr>
...
$html.='<tr>
<td width="17.5%" style="border-top:1px solid #000; border-left:1px solid #000;  height:38px;  border-right:1px solid #000;  font-weight:bold; " align="left">&nbsp; Subject Name</td>

<td width="8.5%" style="border-top:1px solid #000;  font-weight:bold;  border-right:1px solid #000;" align="center">UA1<br>(10)</td>
<td width="8.5%" style="border-top:1px solid #000;  font-weight:bold;  border-right:1px solid #000;" align="center">UA2<br>(10)</td>
<td width="8.5%" style="border-top:1px solid #000;  font-weight:bold;  border-right:1px solid #000;" align="center">&nbsp;MidTerm Total<br>(80)</td>
<td width="8.5%" style="border-top:1px solid #000;  font-weight:bold;  border-right:1px solid #000;" align="center">Total<br>(100)</td>
<td width="8.5%" style="border-top:1px solid #000;  font-weight:bold;  border-right:1px solid #000;" align="center">UA3<br>(10)</td>
<td width="8.5%" style="border-top:1px solid #000;  font-weight:bold;  border-right:1px solid #000;" align="center">UA4<br>(10)</td>
<td width="8.5%" style="border-top:1px solid #000;  font-weight:bold;  border-right:1px solid #000;" align="center">Final Term<br>(80)</td>
<td width="8.5%" style="border-top:1px solid #000;  font-weight:bold;  border-right:1px solid #000;" align="center">Final Total<br>(100)</td>
<td width="8.5%" style="border-top:1px solid #000;  font-weight:bold;  border-right:1px solid #000;" align="center">Grand Total<br>(200)</td>
...
$html.='<tr>
<td width="17.5%" style="border-top:1px solid #000; border-left:1px solid #000; height:15px; line-height:15px; border-right:1px solid #000;  font-weight:bold;" align="left">&nbsp; Social Science</td>';

}else{
	
	$html.='<tr>
<td width="17.5%" style="border-top:1px solid #000; border-left:1px solid #000; height:15px; line-height:15px; border-right:1px solid #000;  font-weight:bold;" align="left">&nbsp; '.$name['exprint'].'</td>';
...
if($newmarks1['marks']!=''){
	...
	$html.='<td width="8.5%" style="border-top:1px solid #000;  border-right:1px solid #000; height:15px; line-height:15px;" align="center">'.$newmaj1.'</td>';				

 $ter1 +=$newmaj1;
  } else {
	  	$html.='<td width="8.5%" style="border-top:1px solid #000;  border-right:1px solid #000; height:15px; line-height:15px;" align="center">'.$newmarks1['marks'].'</td>';	
		...
		$html.='<td width="8.5%" style="border-top:1px solid #000;  border-right:1px solid #000; height:15px; line-height:15px;" align="center">'.$ter1.'</td>';	
$ter=0;
...
$html.='<td width="8.5%" style="border-top:1px solid #000;  border-right:1px solid #000; height:15px; line-height:15px;" align="center">'.$newmaj.'</td>';
 $ter +=$newmaj;
  } else {
	  
	  $html.='<td width="8.5%" style="border-top:1px solid #000;  border-right:1px solid #000; height:15px; line-height:15px;" align="center">'.$newmarks['marks'].'</td>';
	    $ter +=$newmarks['marks'];
	    } 
		...
		$html.='<td width="8.5%" style="border-top:1px solid #000;  border-right:1px solid #000; height:15px; line-height:15px;" align="center">--</td>';
...
elseif ($grade > 30 && $grade < 40)
 ...
 $html.='<td width="8.5%" style="border-top:1px solid #000;  border-right:1px solid #000; height:15px; line-height:15px;" align="center">'.$ter.'</td><td width="8.5%" style="border-top:1px solid #000;  border-right:1px solid #000; height:15px; line-height:15px;" align="center">'.$ters.'</td>
...
<td width="8.5%" style="border-top:1px solid #000;  border-right:1px solid #000; height:15px; border-bottom:1px solid #000; line-height:15px;" align="center">'.$fgj.'</td>
...
<td  style="height:15px; line-height:15px;  font-weight:bold;  text-transform:uppercase; border-right:1px solid #000; border-bottom:1px solid #000;" width="15.26%">
&nbsp; Days Attended
</td>
<td style="height:15px; line-height:15px; text-transform:uppercase;   border-right:1px solid #000;border-bottom:1px solid #000;" width="15.2%" align="center">
&nbsp; '.$daysAttended.'
...
<td style="height:15px; line-height:15px; text-transform:uppercase;  border-right:1px solid #000; border-bottom:1px solid #000; " width="15.2%" align="center">&nbsp; '.$phyidsidr.'</td>
<td style="height:15px; line-height:15px; text-transform:uppercase;  border-right:1px solid #000; border-bottom:1px solid #000; " width="15.2%" align="center">&nbsp; '.$phyidsidr2.'</td>
...
<tr><br>
<td width="25%" align="left" style="line-height:30px; font-weight:bold;" >
Date
</td>

<td width="25%" align="center" style="line-height:30px; font-weight:bold;" >
Class Teacher 
</td>
...
<td width="25%" align="right" style="line-height:30px; font-weight:bold;" >
Principal
</td>
</tr>
