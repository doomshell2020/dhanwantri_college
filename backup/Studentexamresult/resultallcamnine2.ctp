...
<tr>
<td style="text-align:left; line-height:61px;" width="20%" >

<img src="'.SITE_URL.'images/cambridge-2.png" alt="" border="0" style="display:block;" height="60px" width="200px">
</td>

<td style="text-align:center;line-height:43px;" width="60%" align="center">
<img src="'.SITE_URL.'images/logo.png" alt="" border="0" style=" width:160px;" >

</td>

<td style="text-align:right; line-height:15px;" width="20%" align="right"><br><br>';
...
<p style="color:#000; text-align:center; font-size:10px; line-height:12px;"> Affiliation No : IN 276<br>
...
<h2 style="font-size:18px; font-weight:400; text-align:center;line-height:18px;">
Report Card</h2>
</td></tr>
<tr>
<td align="center" width="100%" >
<h4 style="font-size:17px; font-weight:400; text-align:center;line-height:18px;">
Final Term</h4>
</td>
</tr>
<tr>
<td align="center" width="100%" >
<h5 style="font-size:16px; font-weight:400; line-height:18px;">
Cambridge Upper Secondary</h5></td></tr>
<tr>
<td align="center" width="100%" >
<h5 style="font-size:14px; font-weight:400; line-height:18px;">
GRADE : IGCSE YEAR I (GRADE-IX)</h5></td></tr>
<tr>
<td align="center" width="100%">
<h5 style="font-size:13px; font-weight:400; line-height:15px;">
Session : '.$students['student']['acedmicyear'].'</h5>
</td>
</tr>
</table>
<table width="100%">
...
&nbsp; IGCSE Year 1/ '.ucwords(strtolower($fhosue['name'])).'
</td>
</tr>
</table>
...
$html.='<tr><td width="21.5%" style="border-top:1px solid #000; border-left:1px solid #000;  height:38px;  border-right:1px solid #000;  font-weight:bold; " align="left">&nbsp; Subject Name & Code</td>
<td width="8%" style="border-top:1px solid #000;  font-weight:bold;  border-right:1px solid #000;" align="center">UA1<br>(10)</td>
<td width="8%" style="border-top:1px solid #000;  font-weight:bold;  border-right:1px solid #000;" align="center">UA2<br>(10)</td>
<td width="8%" style="border-top:1px solid #000;  font-weight:bold;  border-right:1px solid #000;" align="center">&nbsp;Mid Term<br>(80)</td>
<td width="8%" style="border-top:1px solid #000;  font-weight:bold;  border-right:1px solid #000;" align="center">MidTerm Total<br>(100)</td>
<td width="8%" style="border-top:1px solid #000;  font-weight:bold;  border-right:1px solid #000;" align="center">UA3<br>(10)</td>
<td width="8%" style="border-top:1px solid #000;  font-weight:bold;  border-right:1px solid #000;" align="center">UA4<br>(10)</td>
<td width="8%" style="border-top:1px solid #000;  font-weight:bold;  border-right:1px solid #000;" align="center">Final Term<br>(80)</td>
<td width="8%" style="border-top:1px solid #000;  font-weight:bold;  border-right:1px solid #000;" align="center">Final Total<br>(100)</td>
<td width="8%" style="border-top:1px solid #000;  font-weight:bold;  border-right:1px solid #000;" align="center">Grand Total<br>(200)</td>
<td width="6.5%" style="border-top:1px solid #000;  font-weight:bold; border-right:1px solid #000;" align="center">Grade</td>
...
$fg=array();
 foreach($subject as $key=>$name){ //pr($name); die;
		...
		if($name['is_optional']=='1'){
		 
		 $findoptional=$this->Comman->findoptionalsub($students['stud_id'],$students['sect_id'],$students['class_id'],$name['id']);
		//pr($findoptional);
		 
		 if(empty($findoptional)){
 ...
 foreach($subject as $key=>$name){ 
	 ...
	 if($name['id']=='212' || $name['id']=='213'){
		$name['exprint']="Hindi (0549) /French (0520)"; 
	 }
	  else if($name['id']=='218' || $name['id']=='219'){
		$name['exprint']="Art (0400) /<br>&nbsp;Business Studies (0450)"; 
	 }else{
		$name['exprint']=$name['exprint'].' ('.$name['code'].')';
	 }
	
$html.='<tr>
<td width="21.5%" style="border-top:1px solid #000; border-left:1px solid #000; height:15px; line-height:15px; border-right:1px solid #000; font-weight:bold;font-size:9.2px;" align="left">&nbsp; '.$name['exprint'].'</td>';
...
$html.='<td width="8%" style="border-top:1px solid #000;  border-right:1px solid #000; height:15px; line-height:15px;" align="center">'.$newmaj1.'</td>';

 $ter1 +=$newmaj1;
  } else {
	  
	$html.='<td width="8%" style="border-top:1px solid #000;  border-right:1px solid #000; height:15px; line-height:15px;" align="center">'.$newmarks1['marks'].'</td>';
...
$html.='<td width="8%" style="border-top:1px solid #000;  border-right:1px solid #000; height:15px; line-height:15px;" align="center">'.$ter1.'</td>';
...
if($newmarks['marks']!='' && $name['is_optional']=='0'){
			  
			 $html.='<td width="8%" style="border-top:1px solid #000;  border-right:1px solid #000; height:15px; line-height:15px;" align="center">'.$newmarks['marks'].'</td>';
			 $ter +=$newmarks['marks'];
			 
			 	
		
	} else if($newmarks['marks']!='' && $name['is_optional']=='1') { 
		 $html.='<td width="8%" style="border-top:1px solid #000;  border-right:1px solid #000; height:15px; line-height:15px;" align="center">'.$newmarks['marks'].'</td>';
			 $ter +=$newmarks['marks'];
		}else if($newmarks['marks']=='' && $name['is_optional']=='0') { 
			$html.='<td width="8%" style="border-top:1px solid #000;  border-right:1px solid #000; height:15px; line-height:15px;" align="center">--</td>';
...
$html.='<td width="8%" style="border-top:1px solid #000;  border-right:1px solid #000; height:15px; line-height:15px;" align="center">'.$ter.'</td><td width="8%" style="border-top:1px solid #000;  border-right:1px solid #000; height:15px; line-height:15px;" align="center">'.$ters.'</td>
<td width="6.5%" style="border-top:1px solid #000; border-right:1px solid #000; height:15px; line-height:15px;" align="center">'.$ss.'</td>
</tr>';
$fgj+=$ters;
$bn+=$cn;
...
$html.='<tr>
<td width="85.5%" style="border-top:1px solid #000; border-left:1px solid #000; height:15px; line-height:15px; border-right:1px solid #000; border-bottom:1px solid #000; font-weight:bold;" align="left">&nbsp; Overall Marks & Grade</td>

<td width="8%" style="border-top:1px solid #000;  border-right:1px solid #000; height:15px; border-bottom:1px solid #000; line-height:15px;" align="center">'.$fgj.'</td>

<td width="6.5%" style="border-top:1px solid #000; border-right:1px solid #000; height:15px; border-bottom:1px solid #000; line-height:15px;" align="center">'.$ss1.'</td>
</tr>
</table>
<br><br>
<table width="100%">
...
$artid=$this->Comman->findcoscholsubjectt("Physical Education",$students['class_id']);
...
if($workingdaysid2['marks']){   
	...
	$WorkingDays2=$workingdaysid2['marks'];
...
<tr>
<td style="height:15px; line-height:15px;  font-weight:bold; font-size:9.5px;  text-transform:uppercase; border-right:1px solid #000; border-bottom:1px solid #000;" width="24%">
&nbsp; Areas
</td><td style="height:15px; line-height:15px;  font-weight:bold; font-size:9.5px;  text-transform:uppercase; border-right:1px solid #000; border-bottom:1px solid #000;" width="15.2%" align="center">
&nbsp; Mid Term Grade
</td><td style="height:15px; line-height:15px;  font-weight:bold; font-size:9.5px;  text-transform:uppercase; border-right:1px solid #000; border-bottom:1px solid #000;" width="15.2%" align="center">
&nbsp; Final Term Grade
</td><td style="height:15px; line-height:15px;  font-weight:bold; font-size:9.5px;  text-transform:uppercase; border-right:1px solid #000; border-bottom:1px solid #000;" width="15.2%">
&nbsp; Areas
</td><td style="height:15px; line-height:15px;  font-weight:bold;  font-size:9.5px; text-transform:uppercase; border-right:1px solid #000; border-bottom:1px solid #000;" width="15.2%" align="center">
&nbsp; Mid Term 
</td><td style="height:15px; line-height:15px;  font-weight:bold;font-size:9.5px;   text-transform:uppercase; border-right:1px solid #000; border-bottom:1px solid #000;" width="15.2%" align="center">
...
<tr>
<td style="height:15px; line-height:15px;  font-weight:bold;  text-transform:uppercase; border-right:1px solid #000; border-bottom:1px solid #000;" width="24%">
&nbsp; Activity (Dance/Music/Yoga)
</td>

<td style="height:15px; line-height:15px; text-transform:uppercase; border-right:1px solid #000; border-bottom:1px solid #000;" width="15.2%" align="center">
&nbsp; '.$actidedsr.'
</td>
<td style="height:15px; line-height:15px; text-transform:uppercase; border-right:1px solid #000; border-bottom:1px solid #000;" width="15.2%" align="center">
&nbsp; '.$actidedsr2.'
</td>
<td  style="height:15px; line-height:15px;  font-weight:bold;  text-transform:uppercase; border-right:1px solid #000; border-bottom:1px solid #000;" width="15.2%" >
&nbsp; Working Days
</td>
...
<tr>
<td style="height:15px;  font-weight:bold; line-height:15px;   text-transform:uppercase; border-right:1px solid #000; border-bottom:1px solid #000;" width="24%">
&nbsp; Physical Education
</td>
...
<tr>
<td width="25%" align="left" style="line-height:28px; font-weight:bold;" >
Date
</td>

<td width="25%" align="center" style="line-height:28px; font-weight:bold;" >
Class Teacher 
</td>
...
<td width="25%" align="right" style="line-height:28px; font-weight:bold;" >
Principal
</td>
</tr>
