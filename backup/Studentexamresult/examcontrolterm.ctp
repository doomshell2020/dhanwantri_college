  ...
  <div class="content-wrapper">
    ...
    <section class="content-header ">
      <h1>  <i class="fa fa-upload" aria-hidden="true"></i>
       Upload Second Term (Grade-III/IV/V)  Result 
...
$findexamwitclass=$this->Comman->findsubjectwithclass($h);
		...
		foreach($classnme as $work){
			...
			$findexamwitclass=$this->Comman->findexamwithclass($work['Classes']['id']);
			 ...
			 foreach($findexamwitclass as $key){ if($key['id'] =='23'){

		?>
                <tr>
               <td><?php echo $counter; ?></td>
   
     <?php if($work['Classes']['id']=='18' || $work['Classes']['id']=='19' || $work['Classes']['id']=='1' || $work['Classes']['id']=='2') { ?>
...
if($rtt=='1' || $rtt=='2' || $rtt=='3'){
$csecss = $this->Comman->findclassubject($rtt);

if($csecss['name']=="Mathematics"){
	$sbh="Maths";
}else{
	$sbh=$csecss['name'];
}
