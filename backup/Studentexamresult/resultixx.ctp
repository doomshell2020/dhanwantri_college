...
if($newmarks['marks']!=''){
		 ...
		 $newmarkssanskrit=$this->Comman->fsubjectmarks1($students['stud_id'],$students['sect_id'],$students['class_id'],$er['etype_id'],'26');
...
<td style="border-top:1px solid #000; height:20px;text-align:center; line-height:20px; border-right:1px solid #000; border-bottom:1px solid #000; width:40%;">Upto 30-09-2018</td>
</tr>
</table>
<br><br>
<table width="100%">
