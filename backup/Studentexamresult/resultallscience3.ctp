...
<p style="line-height:5px; font-size:15px;"><b>PRE BOARD EXAMINATION-1</b></p>
...
<td width="48%" style="border-top:1px solid #000;  text-transform:uppercase; height:38px; line-height:20px;  font-weight:bold;  border-right:1px solid #000;" align="center" >&nbsp; SUBJECTS</td>

<td width="40%" style="border-top:1px solid #000; font-weight:bold;  border-right:1px solid #000; line-height:20px;" align="center" > Marks Obtained</td>
</tr>';
...
<td width="48%" style="border-top:1px solid #000; font-weight:bold;  border-right:1px solid #000; height:15px; line-height:15px;" align="center"> '.$name['exprint'].'</td>';
...
if($newmarks['marks']!=''){
		 $html.='<td width="40%" style="border-top:1px solid #000;  border-right:1px solid #000; height:15px; line-height:15px;" align="center">'.$newmarks['marks'].'</td>';
			 ...
			 $html.='<td width="40%" style="border-top:1px solid #000;  border-right:1px solid #000;height:15px; line-height:15px;" align="center">--</td>';
...
$html.='<tr style="font-size:12px;">
<td width="12%" style="border-top:1px solid #000; text-align:center; border-left:1px solid #000; height:15px; line-height:15px; border-right:1px solid #000;  " align="center">&nbsp;  '.$cnt++.'.</td>
<td width="48%" style="border-top:1px solid #000; font-weight:bold;  border-right:1px solid #000; height:15px; line-height:15px;" align="center"> '.$name2['exprint'].'</td>';
$cnt2++;
$ter=0;
$grade=0;
	   foreach($findroleexamtype as $er){  
...
$html.='<tr style="font-size:12px;">
<td width="60%" style="border-top:1px solid #000; font-size:12px; border-left:1px solid #000; height:15px; line-height:15px; border-right:1px solid #000; text-align:center;border-bottom:1px solid #000;   font-weight:bold;" colspan="2">TOTAL</td>
<td width="40%" style="border-top:1px solid #000;  border-right:1px solid #000;border-bottom:1px solid #000; height:15px; line-height:15px;" align="center">'.$total.'</td>
</tr>';


 /* $html.='<tr style="font-size:12px;">
<td width="60%" style="border-top:1px solid #000; font-size:12px; border-left:1px solid #000; height:15px; line-height:15px; border-right:1px solid #000; text-align:center;  font-weight:bold;" colspan="2">TOTAL%</td>
<td width="40%" style="border-top:1px solid #000;  border-right:1px solid #000; height:15px; line-height:15px;" align="center">'.$gradestotal.'%</td>
</tr>


<tr style="font-size:12px;">
<td width="60%" style="border-top:1px solid #000; border-bottom:1px solid #000; font-size:12px; border-left:1px solid #000; height:15px; line-height:15px; border-right:1px solid #000; text-align:center;  font-weight:bold;" colspan="2">ATTENDANCE</td>
<td width="40%" style="border-top:1px solid #000; border-bottom:1px solid #000;  border-right:1px solid #000; height:15px; line-height:15px;" align="center">'.$daysAttended.'/'.$WorkingDays.'</td>
</tr>'; */
