...
<td width="12%" style="border-top:1px solid #000;   font-weight:bold;  border-right:1px solid #000;" align="center" rowspan="2">IA-1<br>50</td>
<td width="24%" style="border-top:1px solid #000;  font-weight:bold;  border-right:1px solid #000;" align="center" colspan="2">SEM-1 100</td>
<td width="14%" style="border-top:1px solid #000;  font-weight:bold;  border-right:1px solid #000;" align="center" rowspan="2">TOTAL<br>150</td>

<td width="12%" style="border-top:1px solid #000; height:38px; line-height:38px;  font-weight:bold; border-right:1px solid #000;" align="center" rowspan="2">%</td>
</tr>
<tr>
<td width="12%" style="border-top:1px solid #000; border-right:1px solid #000; line-height:20px;" align="center" colspan="2">Th</td>
<td width="12%" style="border-top:1px solid #000;   border-right:1px solid #000; line-height:20px;" align="center">Pr</td>
</tr>';
...
if($newmarks['marks']!=''){
		 $html.='<td width="12%" style="border-top:1px solid #000;  border-right:1px solid #000; height:15px; line-height:15px;" align="center">'.$newmarks['marks'].'</td>';
...
$html.='<td width="14%" style="border-top:1px solid #000;  border-right:1px solid #000;height:15px; line-height:15px;" align="center">'.$ter.'</td>
<td  width="12%"  style="border-top:1px solid #000;  border-right:1px solid #000;height:15px; line-height:15px;" align="center">'.$grade.' %</td>';
$html.='</tr>';
...
$grade=0;
	   foreach($findroleexamtype as $er){  
		   ...
		   $newmarks=$this->Comman->fsubjectmarks1($students['stud_id'],$students['sect_id'],$students['class_id'],$er['etype_id'],$name2['id']);
if($newmarks['marks']!=''){
		 $html.='<td width="12%" style="border-top:1px solid #000;  border-right:1px solid #000; height:15px; line-height:15px;" align="center">'.$newmarks['marks'].'</td>';
...
$total +=$ter;
 $html.='<td width="14%" style="border-top:1px solid #000;  border-right:1px solid #000;height:15px; line-height:15px;" align="center">'.$ter.'</td>
<td  width="12%"  style="border-top:1px solid #000;  border-right:1px solid #000;height:15px; line-height:15px;" align="center">'.$grades.' %</td>';
$html.='</tr>';
...
$html.='<tr style="font-size:12px;">
<td width="38%" style="border-top:1px solid #000; font-size:12px; border-left:1px solid #000; height:15px; line-height:15px; border-right:1px solid #000; text-align:center;   font-weight:bold;" colspan="2">TOTAL</td>

<td width="12%" style="border-top:1px solid #000;  border-right:1px solid #000; height:15px; line-height:15px;" align="center"></td>
<td width="12%" style="border-top:1px solid #000;  border-right:1px solid #000;height:15px; line-height:15px;" align="center"></td>
<td width="12%" style="border-top:1px solid #000;  border-right:1px solid #000; height:15px; line-height:15px;" align="center"></td>
<td width="14%" style="border-top:1px solid #000;  border-right:1px solid #000; height:15px; line-height:15px;" align="center">'.$total.'</td>
<td width="12%" style="border-top:1px solid #000; border-right:1px solid #000; height:15px; line-height:15px;" align="center"></td>
</tr>
...
<td width="12%" style="border-top:1px solid #000;  border-right:1px solid #000;height:15px; line-height:15px;" align="center"></td>
<td width="12%" style="border-top:1px solid #000;  border-right:1px solid #000; height:15px; line-height:15px;" align="center"></td>
<td width="14%" style="border-top:1px solid #000;  border-right:1px solid #000; height:15px; line-height:15px;" align="center">'.$gradestotal.'%</td>
<td width="12%" style="border-top:1px solid #000; border-right:1px solid #000; height:15px; line-height:15px;" align="center"></td>
</tr>


<tr style="font-size:12px;">
<td width="38%" style="border-top:1px solid #000; border-bottom:1px solid #000; font-size:12px; border-left:1px solid #000; height:15px; line-height:15px; border-right:1px solid #000; text-align:center;  font-weight:bold;" colspan="2">ATTENDANCE</td>

<td width="12%" style="border-top:1px solid #000; border-bottom:1px solid #000;  border-right:1px solid #000; height:15px; line-height:15px;" align="center"></td>
<td width="12%" style="border-top:1px solid #000; border-bottom:1px solid #000; border-right:1px solid #000;height:15px; line-height:15px;" align="center"></td>
<td width="12%" style="border-top:1px solid #000; border-bottom:1px solid #000;  border-right:1px solid #000; height:15px; line-height:15px;" align="center"></td>
<td width="14%" style="border-top:1px solid #000; border-bottom:1px solid #000;  border-right:1px solid #000; height:15px; line-height:15px;" align="center">'.$daysAttended.'/'.$WorkingDays.'</td>
<td width="12%" style="border-top:1px solid #000; border-bottom:1px solid #000; border-right:1px solid #000; height:15px; line-height:15px;" align="center"></td>
</tr>
...
$physicalsid2e=$this->Comman->findcoactivityresultpdf($students['class_id'],$students['sect_id'],"Term1",$physicalsid['id'],$students['stud_id'],$students['student']['acedmicyear']);

$worlexpridsid2e=$this->Comman->findcoactivityresultpdf($students['class_id'],$students['sect_id'],"Term1",$worlexprid['id'],$students['stud_id'],$students['student']['acedmicyear']);


$genstudridsid2e=$this->Comman->findcoactivityresultpdf($students['class_id'],$students['sect_id'],"Term1",$genstudrid['id'],$students['stud_id'],$students['student']['acedmicyear']);
$Regularityides=$this->Comman->findcoactivityresultpdf($students['class_id'],$students['sect_id'],"Term1",$Regularityid['id'],$students['stud_id'],$students['student']['acedmicyear']);
$Punctualityides=$this->Comman->findcoactivityresultpdf($students['class_id'],$students['sect_id'],"Term1",$Punctualityid['id'],$students['stud_id'],$students['student']['acedmicyear']);

$Cleanlinessides=$this->Comman->findcoactivityresultpdf($students['class_id'],$students['sect_id'],"Term1",$Cleanlinessid['id'],$students['stud_id'],$students['student']['acedmicyear']);
$Teachersides=$this->Comman->findcoactivityresultpdf($students['class_id'],$students['sect_id'],"Term1",$Teachersideid['id'],$students['stud_id'],$students['student']['acedmicyear']);
$Peerides=$this->Comman->findcoactivityresultpdf($students['class_id'],$students['sect_id'],"Term1",$Peerids['id'],$students['stud_id'],$students['student']['acedmicyear']);
$Schoolidee=$this->Comman->findcoactivityresultpdf($students['class_id'],$students['sect_id'],"Term1",$Schoolids['id'],$students['stud_id'],$students['student']['acedmicyear']);
