...
$html.='
<td width="8%" style="border-top:1px solid #000; height:16px; line-height:16px;  font-weight:bold;  border-right:1px solid #000;  text-align:center;" align="center">MO<br>(100)</td>
<td width="8%" style="border-top:1px solid #000; height:16px; line-height:16px;  font-weight:bold; border-right:1px solid #000; text-align:center;" align="center">Grade</td>';
...
$html.='<td width="8%" style="border-top:1px solid #000; height:16px; line-height:16px;  font-weight:bold;  border-right:1px solid #000;  text-align:center;" align="center">MO<br>(100)</td>
<td width="8%" style="border-top:1px solid #000; height:16px; line-height:16px;  font-weight:bold; border-right:1px solid #000; text-align:center;" align="center">Grade</td>
</tr>';
...
$html.='<td width="8%" style="border-top:1px solid #000;  height:20px; line-height:20px;    border-right:1px solid #000;  text-align:center;" align="center">'.sprintf('%.0f', $newmarks['marks']).'</td>';
$ter +=$newmarks['marks'];
}else{
...
$html.='<td width="8%" style="border-top:1px solid #000;  height:20px; line-height:20px;    border-right:1px solid #000;  text-align:center;" align="center">'.$ter.'</td>';
...
$html.='<td width="8%" style="border-top:1px solid #000;  height:20px; line-height:20px;    border-right:1px solid #000;  text-align:center;" align="center">'.$ss1.'</td>';
...
$html.='<td width="8%" style="border-top:1px solid #000;  height:20px; line-height:20px;    border-right:1px solid #000;  text-align:center;" align="center">'.$ter2.'</td>';
...
$html.='<td width="8%" style="border-top:1px solid #000; height:20px; line-height:20px;    border-right:1px solid #000;  text-align:center;" align="center">'.$ss.'</td>';
$html.='</tr>';
...
foreach ($nontheorysub as $key => $name) {
        ...
        foreach ($findroleexamtyp1s as $k => $item) {
			...
			foreach($findroleexamtyp1s as $k=>$item){
				...
				$newmarkss2=$this->Comman->fsubjectmarks2($students['stud_id'],$students['sect_id'],$students['class_id'],$item['id'],$name['id'],2);
				// pr($newmarkss2);die;
			if($newmarkss2['marks']!='' ){										
...
if(!empty($attendncterm1['present'])){
	$html.='<td style="height:16px; line-height:16px; font-size:11px;   text-transform:uppercase;" width="25%"> &nbsp;' . $attendncterm1['total'] . ' / ' . $attendncterm1['present'] . '</td>';
}else{
	$html.='<td style="height:16px; line-height:16px; font-size:11px;   text-transform:uppercase;" width="25%"> &nbsp;' . $attendncterm1['total'] . ' / ' .'absent</td>';

}

$html.='<td style="height:16px; line-height:16px; font-size:11px;   text-transform:uppercase; font-weight:bold;" width="20%">
&nbsp; Attendence Term 2
</td>


<td style="height:16px; line-height:16px; font-size:11px;   text-transform:uppercase;" width="5%">:</td>';
if(!empty($attendncterm2['present'])){
	$html.='<td style="height:16px; line-height:16px; font-size:11px;   text-transform:uppercase;" width="25%"> &nbsp;' . $attendncterm2['total'] . ' / ' . $attendncterm2['present'] . '</td>';
}else{
	$html.='<td style="height:16px; line-height:16px; font-size:11px;   text-transform:uppercase;" width="25%"> &nbsp;' . $attendncterm2['total'] . ' / ' .'absent</td>';
...
//     &nbsp;' . $attendncterm1['present'] . ' / ' . $attendncterm1['total'] . '
//     </td></tr>
//     </table>
//     <br><br>';
// }else{
...
<td width="68%" style="height:32px; line-height:12px;   border-right:1px solid #000;  border-top:1px solid #000;  border-bottom:1px solid #000;">' . $attendncterm2['remarks'] . '. </td>
</tr>
</table></body>
</html>';
//  }else{
