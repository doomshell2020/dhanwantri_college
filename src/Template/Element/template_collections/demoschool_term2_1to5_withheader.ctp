...
<img src="' . SITE_URL . 'demoschool_image/cbse.png" alt="" border="0" style="display:block; " height="70px" width="70px">
</td>

<td style="text-align:center;" width="58%" align="center">

<h1 style="color:#b82329; font-size:35px; line-height:70px; ">Demo School</h1>
...
<img src="' . SITE_URL . 'demoschool_image/cbse.png" alt="" border="0" style="display:block; width:70px;" >
</td>
