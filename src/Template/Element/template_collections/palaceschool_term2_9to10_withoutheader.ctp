...
<br><br>
<table width="100%" border=".5" cellpadding="3" align="center" style="font-size:7.5px;">';

$findroleexamtype1 = $this->Comman->findexamtypesclass($students['class_id'], 1);

$html.='<tr>
<td align="left" width="14%" style="font-weight:bold;">Scholastic Areas</td>
<td colspan="6" align="center" width="36%" style="font-weight:bold;">Term-1 (100 Marks)</td>
<td colspan="6" align="center" width="36%" style="font-weight:bold;">Term-2 (100 Marks)</td>
<td colspan="2" align="center" width="14%" style="font-weight:bold;"></td>
</tr>
<tr>
<th style="font-weight:bold" width="14%" align="left">Name of Subject</th>';

$cbg = 0;
foreach ($findroleexamtype1 as $key => $item) {
  $html .= '<th style="font-weight:bold" width="6%">' . $item['examprint'] . '<br>(' . $item['maxnumber'] . ')</th>';
  $cbg += $item['maxnumber'];
}

$html .='<th style="font-weight:bold" width="6%">Total Term I<br>(50)</th>';
...
$html .='
<th style="font-weight:bold" width="6%">Total Term II<br>(50)</th>
<th style="font-weight:bold" width="7%">Grand Total<br>(100)</th>
<th style="font-weight:bold" width="7%">Overall Grade</th>
</tr>';
...
$subjectcnt = 0;
	foreach ($subject as $key => $name) {
    	...
    	$grandtotalmarks = $ter+$ter2;

		$getgrade = gradecalculation($grandtotalmarks, 100, 100.0);

		$html .= '<td align="center" style="font-weight:bold">' . $grandtotalmarks . '</td>';

    	$html .= '<td align="center" style="font-weight:bold">' . $getgrade . '</td></tr>';
...
<tr>
<td width="50%" align="left">For* Information Technology: Theory-25, Practical-25</td>
<td width="50%" align="left">Printing: Theory-15, Practical-35</td>
</tr>
</table>
<br>
<br>
...
<td width="5%">:</td>
<td width="70%" style="font-weight:bold;" >' . $attendnc['remarks'] . '</td>
</tr>
</table>
</body>
</html>';
