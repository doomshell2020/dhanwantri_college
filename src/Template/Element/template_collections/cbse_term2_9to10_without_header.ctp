...
<table width="100%">
<tr>
<td align="left" width="30%"  style="height:20px; line-height:20px;border-top:1px solid #000; border-left:1px solid #000;  border-right:1px solid #000;"><h2 style=" font-size:10px; font-weight:bold; ">&nbsp; Scholastic Areas:</h2></td>

<td align="center" width="70%" style=" border-top:1px solid #000; height:20px; line-height:20px;  font-weight:bold; border-right:1px solid #000;">
<table width="100%">
<tr>
...
<table width="100%" style="border-bottom:1px solid #000;" align="center">

<tr>
<td rowspan="2"  style="border-top:1px solid #000; border-left:1px solid #000;  height:20px; line-height:50px;  border-right:1px solid #000; font-weight:bold; font-size:11px" width="10%" aling="center">Sr. No.</td>

<td  rowspan="2"  style="border-top:1px solid #000; border-left:1px solid #000;  height:20px; line-height:50px;  border-right:1px solid #000; font-weight:bold; font-size:11px" width="20%" aling="center">Subject</td>

<td colspan="3" style="border-top:1px solid #000; text-align:center; border-left:1px solid #000;  height:20px; line-height:20px;  border-right:1px solid #000; font-weight:bold;" width="27% "align="center">Term 1</td>

<td  colspan="3" style="border-top:1px solid #000;text-align:center; border-left:1px solid #000;  height:20px; line-height:20px;  border-right:1px solid #000; font-weight:bold;" width="27%" align="center">Term 2</td>

<td rowspan="2" style="border-top:1px solid #000; border-left:1px solid #000;  height:20px; line-height:9px;  border-right:1px solid #000; font-weight:bold; font-size:10px" width="16%" aling="center"><br><br><br>Grand Total<br>(100)</td>
</tr>
';
...
$html.='
<td width="11%" style="border-top:1px solid #000; height:16px; line-height:16px;  font-weight:bold;  border-right:1px solid #000;  text-align:center;" align="center">Total (50)</td>';
...
$html.='<td width="11%" style="border-top:1px solid #000; height:16px; line-height:16px;  font-weight:bold;  border-right:1px solid #000;  text-align:center;" align="center">Total (50)</td>
</tr>';
...
<td width="10%" style="border-top:1px solid #000; border-left:1px solid #000;  height:20px; line-height:20px;  border-right:1px solid #000; text-align:left; font-weight:bold;   " align="left">&nbsp;'.$subjectcnt.'</td>
...
$html.='<td width="8%" style="border-top:1px solid #000;  height:20px; line-height:20px;    border-right:1px solid #000;  text-align:center;" align="center">'.$newmarks['marks'].'</td>';
$ter +=$newmarks['marks'];
}else{
	$html.='<td width="8%" style="border-top:1px solid #000;  height:20px; line-height:20px;    border-right:1px solid #000;  text-align:center;" align="center">--</td>';
}

}
$html.='<td width="11%" style="border-top:1px solid #000;  height:20px; line-height:20px;    border-right:1px solid #000;  text-align:center;" align="center">'.$ter.'</td>';
...
$grandtoal=$ter2+$ter;
$html.='<td width="11%" style="border-top:1px solid #000;  height:20px; line-height:20px;    border-right:1px solid #000;  text-align:center;" align="center">'.$ter2.'</td>
<td width="16%" style="border-top:1px solid #000;  height:20px; line-height:20px;    border-right:1px solid #000;  text-align:center;" align="center">'.$grandtoal.'</td>';
