...
<tr>
  ...
  <th style="font-weight:bold" width="6%">Grade</th>
	...
	foreach ($subject as $key => $name) {
		...
		$html .= '<th align="center" style="font-weight:bold">' . $getgrade . '</th>';
		...
		$html .= '<td align="center" style="font-weight:bold">' . $getgrade . '</td>';
		$html .= '</tr>';
	}
...
$html.='<tr>
<td colspan="2" width="100%" style="text-align:right; font-weight:700;">Grade</td>
</tr>
<tr>
<td width="80%" style="text-align:left; font-weight:bold;">' . $name['exprint'] . '</td>
<td width="20%" style="text-align:center; font-weight:bold;">' . $getgrade . '</td>
</tr>';
}
