...
<td align="center" width="78%" style=" border-top:1px solid #000; height:20px; line-height:20px;  font-weight:bold; border-right:1px solid #000;">Term-1 (100 Marks)</td>
</tr>
</table>
<table width="100%" >';
...
<td width="13%" style="border-top:1px solid #000; height:16px; line-height:14px;  font-weight:bold; border-right:1px solid #000; text-align:center;" align="center">Grade</td>';
    ...
    foreach ($subject as $key => $name) {
        ...
        $html .= '<td width="13%"  style="border-top:1px solid #000;  border-right:1px solid #000; border-bottom:1px solid #000; height:20px; line-height:20px;" align="center">' . $ter . '</td>';
        $grade = 0;
        $ss = "";
        if ($ter != 0) {
            // $grade=$ter*100/200; 
        ...
        $html .= '<td width="13%"  style="border-top:1px solid #000;  border-right:1px solid #000; border-bottom:1px solid #000; height:20px; line-height:20px;" align="center">' . $ss . '</td>';
    }
    $html .= '</tr>';
