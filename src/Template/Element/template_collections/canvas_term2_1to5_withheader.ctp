...
if ($studentsj[0]['class_id'] <= 6) {
    $logo = SITE_URL . 'images/canvas_logo_new.png';
} else {
    $logo = SITE_URL . 'canvas_shivnagar_image/student/cl.png';
}
...
foreach ($studentsj as $f => $students) {
    ...
    <table width="100%">
        <tr style="text-align:center; font-size:16px; font-weight:bold;">
            ...
            <img src="' . $logo . '" alt="" border="0" style="display:block; " height="80px" width="80px">
            </td>
        </tr>
