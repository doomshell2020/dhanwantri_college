...
function gradecalculation($obtainedmarks, $totalmarks, $number)
{
    $totalgrade = NULL;
    $totalgrade = round($obtainedmarks * $number / $totalmarks);
...
<td width="8%" style="border-top:1px solid #000; height:32px; line-height:32px;  font-weight:bold; border-right:1px solid #000; text-align:center;">Grade</td>
    ...
    foreach ($subject as $key => $name) {
        ...
        foreach ($findroleexamtype as $er) {
            ...
            // pr($students['student']['acedmicyear']);exit;
        ...
        $ss = gradecalculation($ter3, 200, 100);
...
#000; height:18px; border-bottom:1px solid #000; line-height:18px; font-size:11px; font-weight:bold; text-align:center;">' . $grand . ' ' . $ssss3 . ' </td>';
    ...
    $html .= '<td width="8%" rowspan="2" style="border-top:1px solid #000; border-right:1px solid 
#000; height:18px; border-bottom:1px solid #000; line-height:30px; font-size:11px; font-weight:bold; text-align:center;">' . $ssss3 . ' </td>';
    $html .= '</tr>';

    $html .= '<tr>
<td width="19%" style="border-top:1px solid #000; border-right:1px solid 
#000; border-left:1px solid #000; height:18px; border-bottom:1px solid #000; line-height:18px; font-size:11px; font-weight:bold; text-align:center;">Percentage</td>';
    $totalgrand1 = 0;
    $totalgrand2 = 0;
    foreach ($findroleexamtype1 as $key => $item) {
        $gtotal = 0;
