...
<tr style="line-height:20px;">
 ...
 <td align="center" colspan="8" style="font-size:17px;" ><b><u>To Whom So Ever It May Concern</u></b></td>

   </tr>
<tr>
<p align="left" style="font-size:16px;line-height:30px;">
This is Certified that ' . $g1 . ' <b>' . ucwords(strtolower($name)) . '</b> ' . $g2 . ' <b>' . ucwords(strtolower($father_name)) . '
</b> of Grade First is a bonafide student of <b> THE PALACESCHOOL SCHOOL </b>, The City Palace , Jaipur  in the accademic session <b>' . $session . '</b>.
</p>

<p align="left" style="font-size:16px;line-height:20px;">
'. $g4 .' date of birth as per our school records is ' . date('d-M-Y',strtotime($student['dob'])) . '.
</p>
