...
<p style="text-align:center;margin:5px 0px 5px 0px;font-weight:600">CAMBRIDGE (VI-IX) Result</p>
...
<?php echo $this->Form->create('Logins',array(                      
	...
	<?php echo $this->Form->input('enroll',array('class'=>'form-control','type'=>'number','placeholder'=>'Enrollment Number','id'=>'enroll','label' =>false,'required'=>'required','autocomplete'=>"off")); ?>
    ...
    $('#results').hide();
        ...
        $('#result_form').submit(function(e){
          ...
          $('#results tbody tr').remove();
            ...
            $.ajax({ 
       type: 'POST', 
       url: '<?php echo SITE_URL ;?>Homes/camviewresult',
