...
<body>
    <div id="page-wrapper">
        ...
        <div class="p-slider contant">
            <div class="container">

                <div class="part">
                    <h3 class="channel">
                        How IDS School ERP Software Works
                    </h3>
                    <h4 class="offer">What is the procedure to activate IDS Prime School ERP software
                        for myself or for my school?

                    </h4>
                    <p class="sectors">
                        With IDS Prime , activating your laptop or mobile phone is a piece of cake. It only takes a few
                        clicks/swipes and you can unleash the fountain of information regarding the student, the school,
                        and all the happenings on campus. As a starting point, your login will be activated with your
                        school name on the IDS Prime portal. On predetermined and mutually acceptable terms and
                        conditions, the School will provide the necessary data regarding students, teachers, and related
                        information. A school must have registered with IDS Prime cloud in order to log in as faculty,
                        parents, or students using the IDS Prime web application or mobile app
                    </p>
                ...
                <div class="row py-3 g-0 d-flex align-items-center">
                    <div class="col-md-6">
                        <div class="contants">
                            <ul>
                                <h1>
                                    Getting started with IDS Prime School ERP software, the Virtual
                                    Campus Info-Mine
                                </h1>
                                <li>
                                    <img src="<?php echo SITE_URL; ?>images/chack.png" alt="img">School ERP software For
                                    a School
                                </li>
                                <li>
                                    <img src="<?php echo SITE_URL; ?>images/chack.png" alt="img">Register your school or
                                    institute with IDS Prime School ERP software
                                </li>
                                <li>
                                    <img src="<?php echo SITE_URL; ?>images/chack.png" alt="img">We require you to sign
                                    a contract with Doomshell to take advantage
                                    of our services
                                </li>
                                <li>
                                    <img src="<?php echo SITE_URL; ?>images/chack.png" alt="img">Once you have a
                                    customized admin login and password, you are
                                    ready to go live
                                </li>
                    ...
                    <div class="col-md-6 leaf">
                        <img src="<?php echo SITE_URL; ?>images/erp-4.webp" alt="img">
                        <div class="work">
        ...
        <section id="how" class="two">
            <div class="container">
                ...
                <div class="row py-3 g-0 d-flex align-items-center">
                    <div class="col-md-6 suden">
                        <img src="<?php echo SITE_URL; ?>images/fa.png " class="img-fluid" alt="img">
                    </div>
                    <div class="col-md-6">
                        <div class="contants">
                            ...
                            <ul>
                                <h1 class="add">
                                    School ERP software For a Director / CEO or School Staff
                                </h1>
                                <li>
                                    <img src="<?php echo SITE_URL; ?>images/chack.png" alt="img">As soon as your school
                                    goes live, you will receive your ID and
                                    password.
                                </li>
                                <li>
                                    <img src="<?php echo SITE_URL; ?>images/chack.png" alt="img">Visit the Apple Store
                                    or Google Play Store to download IDS Prime
                                </li>
                                <li>
                                    <img src="<?php echo SITE_URL; ?>images/chack.png" alt="img">To access your Web
                                    account, you can use the mobile app or a PC
                                </li>
                ...
                <div class="row py-3 g-0 d-flex align-items-center">
                    ...
                    <div class="col-md-6">
                        <div class="contants">
                            ...
                            <ul>
                                <h1 class="add">
                                    School ERP software For a Parent
                                </h1>
                                <li>
                                    <img src="<?php echo SITE_URL; ?>images/chack.png" alt="img">The school will send
                                    you your ID &amp; Password (via email or in person)
                                    once it has gone live
                                </li>
                                <li>
                                    <img src="<?php echo SITE_URL; ?>images/chack.png" alt="img">You can download IDS
                                    Prime from the Apple Store or Google Play
                                    Store
                                </li>
                                <li>
                                    <img src="<?php echo SITE_URL; ?>images/chack.png" alt="img">Use the Mobile App or
                                    PC to log in to your Web account
                                </li>
                    ...
                    <div class="col-md-6 serp">
                        <img src="<?php echo SITE_URL; ?>images/pe.png" class="img-fluid" alt="img">
                    </div>
        ...
        <section id="how" class="four">
            <div class="container">
                <div class="row py-3 g-0 d-flex align-items-center">

                    <div class="col-md-6 school">
                        <img src="<?php echo SITE_URL; ?>images/stud.png" class="img-fluid" alt="img">
                    </div>
                    <div class="col-md-6">
                        <div class="contants">
                            ...
                            <ul>
                                <h1 class="add">
                                    School ERP software For a Student
                                </h1>
                                <li>
                                    <img src="<?php echo SITE_URL; ?>images/chack.png" alt="img">When your school goes
                                    live, you will receive your ID and password
                                    (by email or in person)
                                </li>
                                <li>
                                    <img src="<?php echo SITE_URL; ?>images/chack.png" alt="img">Get IDS Prime School
                                    ERP software from the Apple Store or Google Play
                                    Store
                                </li>
                                <li>
                                    <img src="<?php echo SITE_URL; ?>images/chack.png" alt="img">For Web accounts, you
                                    can log in from either a mobile app or a PC
                                </li>
