...
<section class="content-header">
   <h1>
      <i class="fa fa-money"></i> <?php echo $acedmic; ?> Prospectus Summary 
   </h1>
   <ol class="breadcrumb">
...
<table id="" class="table table-bordered table-striped">
   <tbody>
      ...
      <tr>
         <td colspan="10" style="text-align:center;color:red;"><b>No Prospectus Summary Data Available For Year</b></td>
      </tr>
      <?	} ?>
</table>
<div>
