...
<section class="content-header">
   <h1>
      <i class="fa fa-money"></i> <?php echo $acedmic; ?> Admission Detail Summary 
   </h1>
   <ol class="breadcrumb">
...
<table id="" class="table table-bordered table-striped">
   <tbody>
      ...
      <tr>
         ...
         <td><?php echo $element['enroll'];  if($element['category']=="RTE"){ ?><span style='color: red;'>(RTE)</span><?php } ?></td>
