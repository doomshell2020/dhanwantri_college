...
<section class="content-header">
   <h1>
      <i class="fa fa-money"></i> <?php echo $acedmic; ?> Admission Summary 
   </h1>
   <ol class="breadcrumb">
...
<table id="" class="table table-bordered table-striped">
   <tbody>
      ...
      <tr>
         ...
         <td><?php echo date('Y-m-d',strtotime($element['created']));  ?></td>
         ...
         <td><?php if($element['sms_mobile']!=''){ echo $element['sms_mobile'];  }else{  echo "0"; } ?></td>
      </tr>
      <?php  }
         }
         if (empty($registrationsummary)) { ?>
      <tr>
         <td colspan="10" style="text-align:center;color:red;"><b>No Registration Summary Data Available For selected Date</b></td>
      </tr>
      <?	} ?>
</table>
<div>
