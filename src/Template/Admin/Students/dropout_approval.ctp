...
<div class="content-wrapper">
   ...
   <section class="content-header">
      <h1>
         Drop Out Approval Manager
      </h1>
      <ol class="breadcrumb">
         <li><a href="<?php echo ADMIN_URL; ?>dashboards"><i class="fa fa-home"></i>Home</a></li>
         <li><a href="<?php echo ADMIN_URL; ?>students/dropout_approval">Approval Request</a></li>
      </ol>
   </section>
   <!-- Main content -->
                     ...
                     $(document).ready(function() {
                         $("#TaskAdminCustomerForm").bind("submit", function(event) {
                             $.ajax({
                                 ...
                                 type: "POST",
                                 url: "<?php echo ADMIN_URL; ?>students/search_dropout_approval"
                             });
                             return false;
                         });
