...
<tr>
    ...
    <td width="82%"  style="color: #000; margin-top:0px; font-size: 18px; margin-bottom:0px; line-height: 12px;  text-align: center;"><br><b>'.$school_name.'</b><br>
        <span style="text-align:center; display:inline-block; font-size:9px;"><b>'.$sitesetting['subtitle1'].'</b></span><br>
        <span style="text-align:center; display:inline-block; font-size:9px;"><b>'.$address.'</b></span><br>
        <span style="text-align:center; display:inline-block; font-size:9px;"><b>'.$school_number.'</b></span>
    </td>
</tr>
</tbody></table>
<br>
...
<td width="35%" style="height:12px; line-height:12px;">: ' . strtoupper(ucwords($recipt['fee_submittedby'])) . '&nbsp; </td>

<td width="15% " style="height:12px; line-height:12px;">Class.</td>
<td width="25%" style="height:12px; line-height:12px;">: ' . $clas['title'] . ' &nbsp;</td>
</tr>

<tr>
<td width="25%" style="height:12px; line-height:12px;">&nbsp; Pupils Name.</td>
<td width="35%" style="height:12px; line-height:12px;">: ' . strtoupper(ucwords($recipt['fname'])) . ' ' . strtoupper(ucwords($recipt['middlename'])) . ' ' . strtoupper(ucwords($recipt['lname'])) . ' </td>

<td width="15%" style="height:12px; line-height:12px;">Sr.No.</td>
<td width="25%" style="height:12px; line-height:12px;">: ' . $recipt['sno'] . ' &nbsp;</td>
</tr>
    ...
    foreach ($quas as $iteam['quarter'] => $iteam['amount']) {
        ...
        if ($iteam['quarter'] != 'Caution Money') {
            ...
            if ($iteam['quarter'] == 'Admission Fee') {
                ...
                $rg = $this->Comman->findclassfee($recipt['class_id'], $studentfees['acedmicyear']);
                ...
                $aee = ['17', '20', '22', '27'];
                if (!in_array($recipt['class_id'], $aee)) {
                    $lastdatemonthw = "Apr";
                }
...
Net Deposited Rs.:'. number_format($remain).' &nbsp;
</td>
