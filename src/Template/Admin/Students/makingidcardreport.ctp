...
<section class="content-header">
   <h1>
      <i class="fa fa-money"></i> Total Making Card Report 
   </h1>
   <ol class="breadcrumb">
      <li><a href="<?php echo ADMIN_URL;?>dashboards"><i class="fa fa-home"></i>Home</a></li>
      <li><a href="<?php echo ADMIN_URL;?>students/makingidcardreport">Manage Making Card Report </a></li>
   </ol>
</section>
<!-- Main content -->
   ...
   <tbody>
      <tr>
         <td><a id="" style="position: absolute;
            top: 0px;
            /* right: 0px; */
            right: 46px;" class="btn btn-info btn-sm pull-right"  href="<?php echo ADMIN_URL ;?>report/makingcardreport"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Export Excel</a></td>
      </tr>
      <tr>
         <th>No</th>
         <th>Sr.No</th>
      ...
      <?php 
         ...
         $total_discount=0;
          $session = $this->request->session();
                  $session->delete($studentrfidsd); 
                 $session->write('studentrfidsd',$studentrfidsd); 
