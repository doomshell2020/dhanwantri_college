                  ...
                  $(document).ready(function() {
                    $("#TaskAdminCustomerForm").bind("submit", function(event) {
                      $.ajax({
                        ...
                        type: "POST",
                        url: "<?php echo SITE_URL; ?>admin/ClasstimeTabs/assgntimetablesearch"
                      });
                      return false;
                    });
                  });
                ...
                <div class="form-group">
                  <div class="col-sm-4">
                    ...
                    <?php if ($seletedclassid) {
                      echo $this->Form->input('teach_id', array('class' => 'form-control', 'type' => 'select', 'empty' => 'Select Teacher', 'options' => $array, 'value' => $seletedclassid, 'label' => false, 'required'));
                    } else {
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-info">
                ...
                <div id="resizable-tables">
                  <p style="text-align:center;margin-top:10px">Please Select Teacher</p>
                </div>
