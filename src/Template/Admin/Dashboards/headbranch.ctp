        ...
        <div class="container-fluid">
                    ...
                    <div class="column">
                        <div class="detailBlocks danger">
                            <div class="detailBlockIcon  bg-danger">
                                <img src="<?php echo SITE_URL; ?>images/branchesInfo.png" alt="icon" />
                            </div>
                            <div class="blockData">
                                <p>Branches</p>
                                <h5><?php echo $branch_count; ?></h5>
                            </div>
                        </div>
                    </div>
                    <div class="column">
                        <div class="detailBlocks success">
                            ...
                            <div class="blockData">
                                <p>Staff</p>
                                <h5><?php echo $total_emplyoees; ?><small>/<?php echo $dropout_emplyoees; ?></small></h5>
                            </div>
                        </div>
                    </div>
                    <div class="column">
                    ...
                    <div class="column">
                        <div class="detailBlocks warning">
                            <div class="detailBlockIcon bg-warning">
                                <img src="<?php echo SITE_URL; ?>images/attendanceInfo.png" alt="icon" />
                            </div>
                            <div class="blockData">
                                <p>Attendance</p>
                                <h5><?php echo $stu_present_count; ?><small>/<?php echo $stu_absent_count; ?></small></h5>
                            </div>
                        </div>
                    </div>
                    <div class="column">
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="adminBlock">
                        <div class="blockHeader">
                            ...
                            <select class="form-control" onchange="changefeescolletion(this.value);">
                                <option value="<?php echo "All"; ?>">All</option>
                                <?php

                                foreach ($branch_name as $options) {
                                    $branch_name_value =  explode("_", $options);
                                ?>
                                    <option value="<?php echo $options; ?>" id="fees"><?php echo ucfirst($branch_name_value[1]); ?></option>
                                <?php
                                }
                                ?>
                            </select>
                ...
                <div class="col-md-4">
                    <div class="blockHeader">
                        <h3>Statistics</h3>
                        <select class="form-control" onchange="changebranch(this.value);">
                            <option value="All">All</option>
                            <?php
                            foreach ($branch_name as $options) {
                                $branch_name_value =  explode("_", $options);
                            ?>
                                <option value="<?php echo $options; ?>" id="options"><?php echo ucfirst($branch_name_value[1]); ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div id="updt">
                            ...
                            <div class="blockContainer">
                                <ul>
                                    <li class="listView">
                                        ...
                                        <span class="dataView">₹
                                            <?php if ($current_day_fess) {

                                                echo $current_day_fess;
                                            } else {
                                                echo "0";
                                            }
                        ...
                        <div class="blockContainer">
                            <ul>
                                <li class="listView">
                                    ...
                                    <span class="dataView"><?php //echo $admission_count; 
                                                            ?></span>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="adminBlock">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                    <?php $counter = 1;if (count($latest_student) > 0) { //pr($events);?>
                 <?php foreach ($latest_student as $value) {?>
                
                        <tr>
                            <td><?php echo $counter; ?></td>
                            <td><?php echo ucfirst(strtolower($value['fname']));
              ?>&nbsp;<?php echo ucfirst(strtolower($value['middlename']));
                    ?>&nbsp;<?php echo ucfirst(strtolower($value['lname']));
                    ?></td>
                            <td><?php echo ucfirst(strtolower($value['fathername']));; ?></td>
                            <td>
                            <?php    if($value['mobile']){
                                     echo $value['mobile'];
                            }else{
                          ...
                          ?>
                            ...
                            <td><?php echo $value['class']['wordsc'];?></td>
...
<script>
    function changebranch(id) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo ADMIN_URL; ?>Dashboards/getbranchdata',
            data: {
                'options': id
            },
...
<script>
    function changefeescolletion(id) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo ADMIN_URL; ?>Dashboards/getfeesdata',
            data: {
                'options': id
            },
            success: function(data) {
