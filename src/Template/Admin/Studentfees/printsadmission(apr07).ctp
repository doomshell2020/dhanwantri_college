...
<strong>RECEIPT SESSION: ' . $studentfees['acedmicyear'] . '</strong>
    ...
    <td width="30%" style=" line-height:14px; height:14px;border-left:1px solid #000;">&nbsp; Receipt No.</td>
    <td width="30%" style="line-height:14px; height:14px;">:&nbsp; ' . $studentfees['recipetno'] . '</td>
    ...
    <td width="30%" style="line-height:14px; height:14px;border-left:1px solid #000;">&nbsp; Father/Mother\'s Name</td>
    <td width="30%" style="line-height:14px; height:14px;font-size:11px;"><p>:&nbsp; ' . strtoupper(ucwords($students['fee_submittedby'])) . '</p></td>
    ...
    <tr style="font-size:12px;">';
        $n = "&nbsp;Pupil's Name";
        $html .= '<td width="30%" style="border-left:1px solid #000;line-height:14px; height:14px;">&nbsp;' . $n . ' </td>
    <td width="30%" style="text-transform:uppercase;line-height:14px; height:14px;font-size:11px;">:&nbsp;&nbsp;' . strtoupper(ucwords($students['fname'])) . ' ' . strtoupper(ucwords($students['middlename'])) . ' ' . strtoupper(ucwords($students['lname'])) . '</td>
...
<td width="40%" style="line-height:14px; height:14px;font-size:11px;"><p>:&nbsp; ' . strtoupper(ucwords($students['fee_submittedby'])) . '</p></td>
<td width="12%" style="line-height:14px; height:14px;">Class</td>
<td width="28%" style="line-height:14px; height:14px;border-right:1px solid #000; text-transform:uppercase;">:&nbsp; ' . $students['class']['title'] . '-' . $students['section']['title'] . '</td>
</tr>
<tr style="font-size:12px;">';
...
<td width="40%" style="text-transform:uppercase;line-height:14px; height:14px;font-size:11px;">:&nbsp;&nbsp;' . strtoupper(ucwords($students['fname'])) . ' ' . strtoupper(ucwords($students['middlename'])) . ' ' . strtoupper(ucwords($students['lname'])) . '</td>
<td width="12%" style="line-height:14px; height:14px;">Sr. No.</td>
<td width="28%" style="border-right:1px solid #000;line-height:14px; height:14px;">:&nbsp; ' . $students['enroll'] . '</td>
</tr>';
    }
...
<td style="line-height:14px; height:14px;border-left:1px solid #000; border-right:1px solid #000; text-align:right;">&nbsp;&nbsp;' . number_format($lfine, 2) . ' &nbsp; &nbsp; </td>
    ...
    } else if ($db['db'] == "kidsclub") {

        $html .= '<tr style="font-size:12px;">
        <td style="line-height:14px; height:14px;border-left:1px solid #000; text-align:right;" colspan="2"> &nbsp; &nbsp; </td>
        <td style="line-height:14px; height:14px;border-left:1px solid #000; border-right:1px solid #000; text-align:right;">  &nbsp; &nbsp; </td>
        </tr>';
    } else {
...
' . $studentfees['ref_no'] . ' Dt: ' . date('d-m-Y', strtotime($studentfees['paydate'])) . '<br></span>';
    ...
    if ($rtt == '1') {
        ...
        if ($lastdatemonthw) {
            if ($db['db'] == "kidsclub") {
                $html .= '<span>&nbsp;&nbsp;Amount once deposited will not be refunded.</span>';
            } else {
...
<td colspan="3" style="text-align:right;line-height:10px; height:14px;">';
    if ($db['db'] == "kidsclub") {
        $nh = "Principal/Accountant Signature";
    } else {
