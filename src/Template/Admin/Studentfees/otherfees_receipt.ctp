...
if($recipt['mode']=='CHEQUE' ){ 
     ...
     $recipt['mode']='NETBANKING';
        
    }else if($recipt['mode']=='Credit Card/Debit Card/UPI'){
   
     $recipt['mode']='CREDIT CARD /<br>DEBIT CARD';
