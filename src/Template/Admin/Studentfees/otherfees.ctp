                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-sm-3 col-xs-6 " style="margin-bottom:15px;">
                                ...
                                <?php echo $this->Form->input('academicyear', array('type' => 'select', 'options' => $acd, 'empty' => '--Select Academic Year--', 'class' => 'form-control', 'value' => $rolepresentyear, 'label' => false)); ?>
                            </div>
                            <div class="col-sm-3 col-xs-6" style="margin-bottom:15px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6" style="padding-top:20px;">
                                ...
                                <label class="radio-inline"><input type="radio" required id="radio1" name="mode" checked="checked" value="CASH" onclick="return checks(this);">Cash</label>
                                ...
                                <label class="radio-inline"><input type="radio" required id="radio1" name="mode" value="Credit Card/Debit Card/UPI" onclick="return checks(this);">Credit
                                ...
                                <tbody id="example2">
                                    ...
                                    ?>
                                            <tr <?php if ($service['status'] == 'N') { ?> style="color:red;" <?php } ?>>
                                                ...
                                                <td><?php if (isset($service['s_id'])) {
                                                        echo ucfirst($service['s_id']);
                                                    } else {
                                                        echo '--';
                                                    } ?>
                                                </td>
                                                <td><?php if (isset($service['pupilname'])) {
                                                        echo ucfirst($service['pupilname']);
                                                    } else {
                                                        echo 'N/A';
                                                    } ?>
                                                </td>
                                                <td><?php if (isset($service['parentsname'])) { ?>
                                                        <?php echo ucfirst($service['parentsname']); ?> <?php } else {
                                                                                                        echo 'N/A';
                                                                                                    } ?>
                                                </td>
                                                <td><?php if (isset($service['mobile_no'])) {
                                                        echo $service['mobile_no'];
                                                    } else {
                                                        echo 'N/A';
                                                    } ?>
                                                </td>
                                                <td><?php if (isset($service['class_id']) && !empty($service['class_id'])) {
                                                        $class = $this->Comman->findclasses($service['class_id']);
                                                        echo $class[0]['title'];
                                                    } else {
                                                        echo 'N/A';
                                                    } ?></td>
                                                ...
                                                <td><?php if (isset($service['academicyear'])) {
                                                        echo $service['academicyear'];
                                                    } else {
                                                        echo 'N/A';
                                                    } ?>
                                                </td>
                                                <td><?php if (isset($service['paydate'])) {
                                                        echo $date = date("d-m-Y", strtotime($service['paydate']));
                                                    } ?>
                                                </td>
                                                <td><?php if (isset($service['total'])) {
                                                        echo $service['total'];
                                                    } ?></td>
                                                <td><?php if (isset($service['receipt_no'])) {
                                                        echo $service['receipt_no'];
                                                    } ?></td>
                                                <td>
                                                    <a title="Print Receipt" target="_blank" id="<?php echo $service['id']; ?>" target="_blank" href="<?php echo SITE_URL; ?>admin/Studentfees/otherfees_receipt/<?php echo $service['id']; ?>"><i class="fa fa-file-text-o"></i></a>
                                                    ...
                                                    <a title="Cancel Receipt" class="modalcancel" style="margin-left:10px;" data-toggle="modal" data-val="<?php echo $service['id']; ?>" data-id="<?php echo $service['receipt_no']; ?>" data-options="<?php echo $service['academicyear']; ?>" data-target="#myModal"><i class="fa fa-remove"></i></a>
                                                </td>
                                            </tr>
                                        <?php $counter++;
                                        }
