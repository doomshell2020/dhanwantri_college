<div class="content-wrapper">
    ...
    margin-top: -17px;" class="center-block img-circle img-thumbnail profile-img" src="<?php echo $filename; ?>" alt="No Image">
									...
									<div class="text-right">
										...
										<?php if ($students['due_fees'] !== NULL && $students['due_fees'] !== 0 && $this->request->session()->read('Auth.User.db') != "sanskar") { ?><br>
...
none;" name="quater[]" id="s<?php echo $i; ?>-<?php echo $classfee[0]['qu' . $i . '_fees']; ?>" class="quatyid" value="Quater<?php echo $i; ?>" readonly disabled="">
																																					...
																																					if (!in_array("Quater" . $i, $qua)) { ?>
																																						...
																																						<td>
																																							<!---  Fees head if conditions  !-->
																																							<?php   //pr($classfee); die;
																																							?>
																																							<?php if ($classfee['qu4_fees'] == 0 || $classfee['qu4_fees'] == null) {
																																							} else { ?>
																																				...
																																				if ($i == 1) {
																																					if (!in_array("Quater" . $i, $qua)) {   ?>
																																						...
																																						<td>
																																							...
																																							<?php $dat = date('Y-m-d', strtotime($rg['qu' . $i . '_date']));
																																							if ($dat != '1970-01-01') {
																																								echo date('d-m-Y', strtotime($dat));
																																							} else {
																																								echo "not-set";
