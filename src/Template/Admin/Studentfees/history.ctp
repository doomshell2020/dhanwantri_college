<div class="content-wrapper">
    ...
    color: aliceblue;">
			<ul class="nav nav-tabs responsive hidden-xs hidden-sm" id="">
				<li class="active" id="personal-tab"><a style="background: #00C0EF;color:#fff" href="<?php echo ADMIN_URL; ?>studentfees/history/<?php echo $id; ?>/<?php echo $academic_year; ?>?id=personal"><i class="fa fa-street-view"></i> Fee Structure <? echo $academic_year; ?> </a></li>
				<? if ($students['category'] != "RTE") { ?>
					<li class="" id="personal-tab"><a style="background: #00C0EF;color:#fff" title="Tution Fees Acknowledgement  <?php echo $students['acedmicyear']; ?>" target="_blank" href="<?php echo SITE_URL; ?>admin/report/feeacknowledgementhistory/<?php echo $students['stud_id']; ?>/<?php echo $students['acedmicyear']; ?>"> Fee Acnowledgement <?php echo $students['acedmicyear']; ?></a> </li> <?php } ?>
			</ul> History Fee
		</h1>
		<ol class="breadcrumb">
			<li><a href="<?php echo ADMIN_URL; ?>studentfees/view"><i class="fa fa-home"></i>Home</a></li>
			<li><a href="<?php echo ADMIN_URL; ?>studentfees/history/<?php echo $id; ?>/<?php echo $academic_year; ?>?id=personal">Manage Student History Fee</a></li>
						...
						<div class="box box-solid">
							<div class="box-header left-align">
								<div class="user-block col-sm-9 no-padding">
									...
									$filename = IMAGE_URL . $db['db'] . 'img/' . $bordd . $students['enroll'] . '.JPG';
    ...
    height: 85px;
    float: left;
    margin-top: -17px;" class="center-block img-circle img-thumbnail profile-img" src="<?php echo $filename; ?>" alt="No Image">
									...
									<a href="#"><?php echo ucfirst($students['fname']); ?> <?php echo ucfirst($students['middlename']); ?> <?php echo ucfirst($students['lname']); ?></a> (<b style="color:green;"><?php echo $students['enroll']; ?></b>)
									...
									<? if ($acedmicyears) {
										...
										$dff = $this->Comman->findridacademicreerty($students['stud_id'], $acedmicyears);

										$dff4 = $this->Comman->findri2($students['enroll'], $acedmicyears);
										if ($dff['id']) { ?>

											<strong class="pull-right" style="color:red;">Current Session : <a href="<? echo ADMIN_URL; ?>studentfees/index/<? echo $students['stud_id']; ?>/<? echo $acedmicyears; ?>" class="btn btn-info "> <? echo $acedmicyears; ?> </a> </strong>


										<?  } else if ($dff4['id']) { ?> <strong class="pull-right" style="color:red;">Current Session : <a href="<? echo ADMIN_URL; ?>studentfees/index/<? echo $dff4['id']; ?>/<? echo $acedmicyears; ?>" class="btn btn-info "> <? echo $acedmicyears; ?> </a> </strong> <? }
																																																																									} ?>
									...
									<span class="description">
										...
										<strong>House </strong> : <?php $house = $this->Comman->findhouse($students['h_id']);
																	echo $house['name']; ?> |
										<strong>Father Name </strong> : <?php echo $students['fathername']; ?> | <strong>Mobile No. : </strong> <?php echo $students['mobile']; ?> | <a class="btn btn-primary btn-sm globalModals f-right" href="<?php echo SITE_URL; ?>admin/studentfees/viewsibling/<?php echo $students['stud_id'] ?>" data-target="#globalModal" data-toggle="modal" float: right;>View Siblings</a>
...
<?php if ($is_transport == '1') { ?>
    ...
    sum += parseFloat($(this).val());
										...
										<div id="content" class="tab-content responsive hidden-xs hidden-sm">
											...
											<div class="tab-pane active" id="personal">
												...
												<? if ($students['category'] != "") {  ?>
													<form method="post" enctype="multipart/form-data" accept-charset="utf-8" class="form-horizontal" id="sevice_form" validate="validate" action="<?php echo ADMIN_URL; ?>studentfees/addhistory">
														...
														<div class="row">
															<div class="col-lg-6">
																...
																foreach ($student_datas3s as $kss => $valuess) {
																	$quas3[] = unserialize($valuess['quarter']);
																}
																...
																if (in_array("Admission Fee", $qua2) || in_array("Development Fee", $qua2) || in_array("Caution Money", $qua2)) {

																	if (in_array("Admission Fee", $qua2) &&  !in_array("Admission Fee", $qua)) {
																	...
																	if (in_array("Development Fee", $qua2) &&  !in_array("Development Fee", $qua)) {

																		$qua[] = "Development Fee";
																	}

																	if (in_array("Caution Money", $qua2) &&  !in_array("Caution Money", $qua)) {
																...
																if (in_array("Admission Fee", $qua3) || in_array("Development Fee", $qua3) || in_array("Caution Money", $qua3)) {

																	if (in_array("Admission Fee", $qua3) &&  !in_array("Admission Fee", $qua) &&  !in_array("Admission Fee", $qua2)) {
																	...
																	if (in_array("Development Fee", $qua3) &&  !in_array("Development Fee", $qua) &&  !in_array("Development Fee", $qua2)) {

																		$qua[] = "Development Fee";
																	}

																	if (in_array("Caution Money", $qua3) &&  !in_array("Caution Money", $qua) &&  !in_array("Caution Money", $qua2)) {

																		$qua[] = "Caution Money";
																	}

																	if (in_array("Miscellaneous Fee", $qua3) &&  !in_array("Miscellaneous Fee", $qua) &&  !in_array("Miscellaneous Fee", $qua2)) {

																		$qua[] = "Miscellaneous Fee";
																	}

																	if (in_array("Quater1", $qua3) &&  !in_array("Quater1", $qua) &&  !in_array("Quater1", $qua2)) {

																		$qua[] = "Quater1";
																	}


																	if (in_array("Quater2", $qua3) &&  !in_array("Quater2", $qua) &&  !in_array("Quater2", $qua2)) {

																		$qua[] = "Quater2";
																	}

																	if (in_array("Quater3", $qua3) &&  !in_array("Quater3", $qua) &&  !in_array("Quater3", $qua2)) {
																			...
																			<tbody>
																				...
																				?><tr>
																							...
																							<? if ($findfee['name'] == "Admission Fee") {
																								if ((!in_array("Admission Fee", $qua)) && (!in_array("Admission Fee", $qua2))) {   ?>
																								...
																								if ((!in_array("Development Fee", $qua))  && (!in_array("Development Fee", $qua2))) {  ?><td style="width:4px;">
																										<label>
																								...
																								if ((!in_array("Caution Money", $qua))  && (!in_array("Caution Money", $qua2))) {  ?><td style="width:4px;">
																										<label>
	 ...
	 transparent;border: none;" name="quater[]" id="s<? echo $y; ?><? echo
																								...
																								if ((!in_array("Caution Money", $qua))  && (!in_array("Caution Money", $qua2))) {  ?>
	 ...
	 transparent;border: none;" name="quater[]" id="s<? echo $y; ?><? echo $jk; ?>-<?php echo $value['qu' . $jk . '_fees']; ?>" class="paper1 quatyid" value="<? echo $findfee['name']; ?>" readonly disabled="">
																								...
																								if ((!in_array("Development Fee", $qua))  && (!in_array("Development Fee", $qua2))) {   ?>
																									<td> <input type="text" style="background-color:
	  transparent;border: none;" name="quater[]" id="s<? echo $y; ?><? echo $jk; ?>-<?php echo $value['qu' . $jk . '_fees']; ?>" class="quatyid" value="<? echo $findfee['name']; ?>" readonly disabled="">
																								...
																								if (!in_array("Miscellaneous Fee", $qua)) {  ?><td> <input type="text" class="quatyid" style="background-color: transparent;border: none;" name="quater[]" id="s<? echo $y; ?><? echo $jk; ?>-<?php echo $value['qu' . $jk . '_fees']; ?>" value="<? echo $findfee['name']; ?>" readonly disabled="">
																										<input type="hidden" class="fehaedf" style="background-color: transparent;border: none;" id="sp<? echo $y; ?><? echo $jk; ?>-<?php echo $value['qu' . $jk . '_fees']; ?>" value="<? echo $findfee['id']; ?>" readonly disabled="">
																									</td>
																							...
																							<? if ($findfee['name'] == "Admission Fee") {
																								if ((!in_array("Admission Fee", $qua)) && (!in_array("Admission Fee", $qua2))) {   ?>
																									<td align="center"><span class="text-black">&#8377; </span><?php
																																								...
																																								?>
																											<input type="text" name="amountl[]" style="width: 34%;" maxlength="6" minlength="1" id="amoun1" readonly="readonly" class="amounedit" value="<? echo $value['qu' . $jk . '_fees']; ?>">&nbsp;&nbsp;
																											<a href="javascript:void(0);" class="remove_special" style="font-weight: bold; font-size:
	   16px;color:red;display:none;"><i class="fa fa-times"></i></a>
																										<?
																																								} else {
																																									echo "not-set";
																																								} ?>
																								...
																								if ((!in_array("Caution Money", $qua))  && (!in_array("Caution Money", $qua2))) {  ?>
																									...
																									<td align="center"><span class="text-black">&#8377; </span><?php
																																								if ($dat != '1970-01-01') { //echo number_format($value['qu'.$jk.'_fees']);
																																								?>
																											<input type="text" name="amountl[]" id="amoun2" maxlength="6" minlength="1" style="width:
	   34%;" readonly="readonly" class="cautionedit" value="<? echo $value['qu' . $jk . '_fees']; ?>">&nbsp;&nbsp;
																								...
																								if ((!in_array("Development Fee", $qua))  && (!in_array("Development Fee", $qua2))) {  ?>
																									<td align="center"><span class="text-black">&#8377; </span><?php
																																								if ($dat != '1970-01-01') { //echo number_format($value['qu'.$jk.'_fees']); 
																																								?>
																											<input type="text" name="amountl[]" id="amoun3" maxlength="6" minlength="1" style="width: 34%;" readonly="readonly" class="amounedit" value="<? echo $value['qu' . $jk . '_fees']; ?>">&nbsp;&nbsp;
																								...
																								if (!in_array("Miscellaneous Fee", $qua)) {  ?><td align="center"> <span class="text-black">&#8377; </span><?php
																									if ($dat != '1970-01-01') {  //echo number_format($value['qu'.$jk.'_fees']); 
																	?>
																											<input type="text" name="amountl[]" id="amoun4" maxlength="6" minlength="1" style="width: 34%;" readonly="readonly" class="amounedit" value="<? echo $value['qu' . $jk . '_fees']; ?>">&nbsp;&nbsp;
																											...
																											<td style="width:4px;">
																												<label>
																													<input type="checkbox" id="chk<?php echo $i; ?>-<?php echo
																																									$classfee[0]['qu' . $i . '_fees']; ?>" class="StuAttendCk lnm" name="amount[]" <?php if ($clodate < $currentdoat) { ?> onclick="check(<?php echo $i;
				...
				<? */ ?>
																							...
																							<td>
																								...
																								if ($dats != '1970-01-01') {
																									...
																									$acedmicdd = date('Y', strtotime($dats));
																									$previ = explode('-', $academic_year);
																								} else {
																									echo "not-set";
																								} ?>
																							...
																							<td>
																								...
																								?>
																									...
																									<a title="Print Caution Money" target="_blank" href="<? echo ADMIN_URL; ?>studentfees/printscautionhistory/<?php echo $valsf['id']; ?>/<?php echo $academic_year; ?>"><i class="fa fa-file-text-o"></i></a>
																									<? if ($acedmicdd > $previ[0]) { ?>
																										<a title="Cancel Receipt" onclick="return confirm('Are You Sure? Do You Want To Cancel Reference No : <?php echo $valsf['recipetno']; ?> !!')" href="<? echo ADMIN_URL; ?>studentfees/addhistory/<?php echo $valsf['id']; ?>/<?php echo $academic_year; ?>"><i class="fa fa-remove"></i></a>
																									<? } ?>

																								<? } else {  ?>
																									<a title="Print Receipt" target="_blank" href="<? echo ADMIN_URL; ?>studentfees/printsadmissionhistory/<?php echo $valsf['id']; ?>/<?php echo $academic_year; ?>"><i class="fa fa-file-text-o"></i></a>
																									<? if ($acedmicdd > $previ[0]) { ?>
																										<a title="Cancel Receipt" onclick="return confirm('Are You Sure? Do You Want To Cancel Reference No : <?php echo $valsf['recipetno']; ?> !!')" href="<? echo ADMIN_URL; ?>studentfees/addhistory/<?php echo $valsf['id']; ?>/<?php echo $academic_year; ?>"><i class="fa fa-remove"></i></a>
																		...
																		<table class="table table-striped table-hover table-condensed table-responsive" id="mytable">
																			...
																			<tbody>
																				...
																				<? if ($student_datas3s) {
																					$quass34 = array();
																					foreach ($student_datas3s as $valsf) {
																							...
																							<tr>
																								...
																								<td>
																									...
																									?>
																										...
																										<a title="Print Caution Money" target="_blank" href="<? echo ADMIN_URL; ?>studentfees/printscautionhistory/<?php echo $valsf['id']; ?>/<?php echo $valsf['acedmicyear']; ?>"><i class="fa fa-file-text-o"></i></a>
																	...
																	<tbody>
																		...
																		if ($student_feepending) {
																			...
																			foreach ($student_feepending as $val) {
																				...
																				$sert = $this->Comman->findridacademic($val['r_id'], $students['acedmicyear']);
																...
																<table class="table table-striped table-hover table-condensed table-responsive" id="mytable">
																	<tbody>
																		...
																		<?php if (isset($classfee) && !empty($classfee)) {  ?>
																			<div>
																				<tr class="assets_container">
																					<td colspan="4" width="50%">
																						...
																						<b>Other Fee Charge : &nbsp; </b><select name="quater[]" class="chkotherfeer" id="chkotherfee" onChange="chkotherfsees('chkotherfee');">
																			...
																			<script>
																				/*
		window.checkpracticals = function (sid,idd) {
		var chkboxsss='';
	var chkboxsss = document.getElementById(idd);

		      if(chkboxsss.checked)
		    {


	  $.each($(".chkotherfeer option:selected"), function(){
if($(this).val()=='5'){

var yid=$(this).parent('select').attr('id');
$('#'+yid).prop('selectedIndex',0);
$('#'+yid).trigger('change');
...
$('#'+yid).trigger('change');
			     ...
			     $('#'+idd).removeAttr("checked","checked");
			     $('#'+idd).prop( "checked", false );
						...
						*/
																			...
																			<? if (
																				$students['class_id'] == 12 || $students['class_id'] == 13
																					...
																					foreach ($compsid as $k => $g) {
																						...
																						if ($subjectpracticals) { ?>
																							...
																							<td>
																								...
																								<input type="checkbox" readonly disabled="disabled" id="<? echo $subjectpracticals['id']; ?>" onclick="checkpracticals(<?php echo
																																																						$subjectpracticals['is_practicalfee']; ?>,<? echo
																							$subjectpracticals['id']; ?>)" checked class='practicald' value="<?php echo $subjectpracticals['is_practicalfee'];  ?>" />
																							</td>
																					...
																					foreach ($opt_sid as $ks => $gs) {
																						...
																						if ($subjectpracticalss) { ?>
																							...
																							<td>
																								...
																								<input type="checkbox" readonly disabled="disabled" id="<? echo $subjectpracticalss['id']; ?>" onclick="checkpracticals(<?php echo
																																																						$subjectpracticalss['is_practicalfee']; ?>,<? echo
																							$subjectpracticalss['id']; ?>)" checked class='practicald' value="<?php echo $subjectpracticalss['is_practicalfee'];  ?>" />
																							</td>
			 ...
			 $("#depositamt").on('blur change', function() {
																			...
																			<tr>
																				<td colspan="8">
																					...
																					<input type="hidden" name="student_id" value="<?php echo $students['stud_id']; ?>">
																					<input type="hidden" name="studenthistory" value="Y">
...
" id="pd<?php echo $i; ?><?php echo $transportfeess[0]['qu' . $i . '_fees']; ?>" class="abs_remark form-control " value="<?php echo date('d-m-Y', strtotime($paydatevalues['paydate'])); ?>" name="paydate[]" disabled="" maxlength="50" placeholder="Enter Paydate">
																					...
																					<td>
																						<div class="form-group field-1">
																							<div class="col-lg-6">
																								<?php if (!in_array("Quater" . $i, $quatrans)) {  ?>
																									-<?php } else {  ?> <a title="Print Receipt" href="<?php echo SITE_URL; ?>admin/studentfees/printstransport/<?php echo $students['stud_id']; ?>/<?php echo "Quater" . $i; ?>/<?php echo $students['acedmicyear']; ?>"><i class="fa fa-file-text-o"></i></a><?php
																																																																																						} ?></div>
																						</div>
																					</td>
															...
															<div class="col-lg-12">
																<table class="table table-striped table-hover" id="mytable">
																	...
																	<tbody>
																		...
																		<tr>
																			<td> <?php $due = $this->Comman->findstuduefees($students['stud_id']); ?>
																				<label><input type="hidden" name="student_id" value="<?php echo $id; ?>">
