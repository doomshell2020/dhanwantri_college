...
if($studentfees['mode']!='Cash'){ 
$html.='&nbsp; <span>Paid by Chq.No.: '.$studentfees['cheque_no'].' Dt:'.date('d-m-Y',strtotime($studentfees['paydate'])).' '.$studentfees['bank_id'].'<br></span>';
}
$html.='<span>&nbsp;&nbsp;Next Due on 10, Apr after Due Date Rs. 0 per day fine will be charged. Amount once deposited will not be refunded<br> &nbsp; Remarks:
</span>
</td>
</tr>
