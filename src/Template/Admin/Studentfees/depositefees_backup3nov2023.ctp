                        ...
                        <div class="user-block col-sm-12 no-padding">
                           ...
                           <span class="username">
                              <a href="<?php echo SITE_URL; ?>admin/students/view/<?php echo $students['id']; ?>">
                                 <?php echo ucfirst($students['fname']); ?> <?php echo ucfirst($students['middlename']); ?>
                                 <?php echo ucfirst($students['lname']); ?>
                              </a> (<b style="color:green;"><?php echo $students['enroll']; ?></b>) <? if ($students['is_transport'] == 'Y') { ?> <i class="fa fa-bus" href="<?php echo SITE_URL; ?>admin/studentfees/is_droptrans/<? echo $students['id']; ?>/<? echo $students['acedmicyear']; ?>" data-target="#globalModaldrop" data-toggle="modal" data-modal-size="modal-lg" aria-hidden="true"> </i> <? } ?>
                           ...
                           <span class="description">
                              <strong>Course </strong> : <?php echo $students['class']['title']; ?> |
                              <strong>Year/Semester </strong> : <?php echo $students['section']['title']; ?> |
                              <strong>Batch </strong> : <?php echo $students['batch']; ?> |
                                       ...
                                       <div class="d-flex" style="justify-content:space-between">
                                          ...
                                          if ($students['due_fees'] > 0 && $students['due_fees'] !== 0) { ?>
                                             <p class="text-right">
                                                <a href="javascript:void(0);" class="btn btn-info " style="color: #fff !important;font-weight: bold;">
                                                   <span class="text-black">Previous Year Due- ₹ </span>
                                                   <span> <?php echo $students['due_fees']; ?> </span>
                                                   <span style="color:red;">***</span>
                                                </a>
                                                <input type="hidden" id="due_amount" value="<?php echo $students['due_fees']; ?>">
                                             </p>
                                          ...
                                          <div class="col-lg-6">
                                             ...
                                             if ($studentfees2s) {
                                                ...
                                                foreach ($quaflj as $jlj => $tlj) {
                                                   ...
                                                   if ($jlj == "Admission / Prosspectus" || $jlj == "Annual Charges" ||  $jlj == "Pocket Articles" || $jlj == "Books" || $jlj == "Pocket Articles" || $jlj == "Quater1" || $jlj == "Quater2" || $jlj == "Quater3" || $jlj == "Quate4" || $jlj == "Uniform" || $jlj == "Collage Caution Money (Refundable)" || $jlj == "Enrollment Fees" || $jlj == "Hostel Caution Money" || $jlj == "Transportation Fees" || $jlj == "Library Fees") {
                                                      $qua[] = $jlj;
                                                   }
                                                }
                                             }
                                             ...
                                             if (in_array("Admission / Prosspectus", $qua2s) || in_array("Health Insurance", $qua2s) || in_array("Pocket Articles", $qua2s) || in_array("Collage Caution Money (Refundable)", $qua2s) || in_array("Transportation Fees", $qua2s) || in_array("Health Insurance", $qua2s) || in_array("Library Fees", $qua2s)) {
                                                            ...
                                                            for ($i; $i <= $students['section_id']; $i++) {
                                                               ...
                                                               if ($showRow) { ?>
                                                                  ...
                                                                  <tr>
                                                                     ...
                                                                     <td style="width: 4px;">
                                                                        <label>
                                                                           <input type="checkbox" id="chk<?php echo $i; ?>-<?php echo $tutionfeesyearly; ?>" class="StuAttendCk lnm" name="amount[]" onclick="check(<?php echo $i; ?>,<?php echo $tutionfeesyearly; ?>,<?php echo $discount_fees; ?>)" value="<?php echo $tutionfeesyearly; ?>">
                                                                        </label>
                                                                     </td>
                                                                     <td>
                                                               ...
                                                               for ($u; $u <= $students['section_id']; $u++) {
                                                                  ...
                                                                  if ($hideShowRow) { ?>
                                                                     ...
                                                                     <tr>
                                                                        <td style="width: 4px;">
                                                                           <label>
                                                                              <input type="checkbox" id="chk<?php echo $i; ?>-<?php echo $transportfeesyearly; ?>" class="StuAttendCk lnm" name="amount[]" onclick="check(<?php echo $i; ?>,<?php echo $transportfeesyearly; ?>,<?php echo $discount_fees; ?>)" value="<?php echo $transportfeesyearly; ?>">
                                                                           </label>
                                                                        </td>
                                                                        <td>
                                                                           <input type="text" style="background-color: transparent;border: none;" value="<?php echo $quarterLabel; ?>" readonly>
                                                            ...
                                                            foreach ($studentfeesk as $numKey => $valsf) {
                                                               ...
                                                               <tr>
                                                                  ...
                                                                  <td>
                                                                     ...
                                                                     <?php if ($numKey === $totalRecords - 1) { // Check if this is the last record 
                                                                     ?>
                                                                        <a title="Cancel Receipt" class="modalcancel" data-toggle="modal" data-val="<?php echo $valsf['id']; ?>" data-id="<?php echo $valsf['recipetno']; ?>" data-options="<?php echo $academic_year; ?>" data-target="#myModal"><i class="fa fa-remove"></i></a>
                                                                     <?php } ?>
                                             ...
                                             <div class="table-responsive">
                                                <table class="table table-striped table-hover table-condensed table-responsive" id="mytable">
                                                   <tbody>
                                                      ...
                                                      <?
                                                      //  $nk = '51';
                                                      $nk = 10001; //eplace this condition by Rupam 05/08/2023
                                                            ...
                                                            if ($sert) { ?>
                                                               <tr>
                                                                  <td style="width:4px;">
                                                                     ...
                                                                     <label>
                                                                        <input id="chk<?php echo $nk; ?>-<?php echo round($val['amt']); ?>" class="StuAttendCkrg" name="amounts[<?php echo $k; ?>]" onclick="checkpending(<?php echo $nk; ?>, <?php echo round($val['amt']); ?>, 0)" value="<?php echo $val['amt']; ?>" type="checkbox">
                                                                     </label>
                                 ...
                                 ?>
                                  ...
                                  stuattendance-sa_date " readonly="readonly" name="paydate" maxlength="50" placeholder="Enter Paydate" value="<? echo date('d-m-Y'); ?>" required="">
                                                         ...
                                                         <tr>
                                                            ...
                                                            <td colspan="4">
                                                               <b>Deposit Amount :&nbsp; <span class="text-black">&#8377; </span> </b>
                                                         ...
                                                         <tr>
                                                            ...
                                                            <td colspan="4" id="ref" style="display:none;">
                                                               <b>Reference No. :&nbsp; </b>
                                                               <input type="text" id="refno" style="max-width: 152px;" placeholder="Reference Number" name="ref_no" maxlength="25">
                                                            </td>
                                                         </tr>
                                                      ...
                                                      <tr id="forpreviouseyear">
                                                         <td colspan="8">
                                                            <label>Choose Heads (Hold CTRL to select multiple options):</label>
                                                            <select name="forpreviouseyear[]" class="form-control" multiple style="height: 150px;">
                                                               <?php foreach ($completeFeesheads as $feesHeadIndex => $feesheadName) { ?>
                                                                  <option value="<?php echo $feesheadName; ?>"><?php echo $feesheadName; ?></option>
                                                               <?php } ?>
                                                            </select>
                                                         </td>
