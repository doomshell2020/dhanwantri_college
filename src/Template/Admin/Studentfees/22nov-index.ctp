							...
							<div class="box-header left-align">
								<div class="user-block col-sm-9 no-padding">
									...
									<img class="img-circle img-bordered-sm" src="<?php echo SITE_URL; ?>images/stu-image.png" alt="No Image"> <span class="username">
										<a href="<?php echo SITE_URL; ?>admin/students/view/<?php echo $students['id']; ?>"><?php echo ucfirst($students['fname']); ?> <?php echo ucfirst($students['middlename']); ?> <?php echo ucfirst($students['lname']); ?></a> (<b style="color:green;"><?php echo $students['enroll']; ?></b>)
									...
									<span class="description">
										...
										<strong>House </strong> : <?php $house = $this->Comman->findhouse($students['h_id']);
																	echo $house['name']; ?> |
										<strong>Father Name </strong> : <?php echo $students['fathername']; ?> | <strong>Mobile No. : </strong> <?php echo $students['mobile']; ?> | <a class="btn btn-primary btn-sm globalModals f-right" href="<?php echo SITE_URL; ?>admin/studentfees/viewsibling/<?php echo $students['id'] ?>" data-target="#globalModal" data-toggle="modal" float: right;>View Siblings</a>



									</span> <? $findpendings = $this->Comman->studentshistory($students['id']);
											if ($findpendings['stud_id']) {  ?> <?
																																					...
																																					if ($fetchdetail != '--') {  ?> <strong class="pull-right" style="color:red; margin-right: -135px;"> Pending history : <span class="text-black">₹ </span> <? echo $fetchdetail; ?></strong><? } ?> <a href="<? echo ADMIN_URL; ?>studentfees/history/<? echo $findpendings['stud_id']; ?>/<? echo $findpendings['acedmicyear']; ?>" class="btn btn-info pull-right"> <? echo $findpendings['acedmicyear']; ?> </a> <? } ?>
																				...
																				?>
																						<tr>
																							...
																							<? if ($findfee['name'] == "Admission Fee") {
																								if ((!in_array("Admission Fee", $qua)) && (!in_array("Admission Fee", $qua2))) {   ?><td style="width:4px;">
																										<label>
