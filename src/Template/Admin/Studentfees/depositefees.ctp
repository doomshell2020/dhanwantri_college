...
<div class="content-wrapper">
   <section class="content-header">
    ...
    color: aliceblue;">
        ...
        <a style="background: #00C0EF;color:#fff"><i class="fa fa-street-view"></i> Fee Structure <? //echo $academic_year; 
                                                                                                   ?></a>
      </li> -->
            <? if ($students['category'] == "RTE") { ?>
               <li class="" id="personal-tab">
                  <a style="background: #00C0EF;color:#fff" title="Tution Fees Acknowledgement  <?php echo $students['acedmicyear']; ?>" target="_blank" href="<?php echo SITE_URL; ?>admin/report/feeacknowledgement/<?php echo $students['id']; ?>/<?php echo $students['acedmicyear']; ?>">
                     Fee Acnowledgement <?php echo $students['acedmicyear']; ?></a>
               </li>
            <?php }
            // pr($db);exit;
   ...
   <script type="text/javascript">
      $(function() {
         ...
         window.check = function(sid, id, discount, dat) {
            ...
            if ($(".check-alls").prop('checked') == true) {} else {}
            ...
            var chkbox = document.getElementById(ck);
            var selec = $("#" + ck).attr('class');
            // if (selec.split(' ').includes('transclass')) {
            var isd = $("#" + ck).val();
            var id = isd;

            // if (sid == 11 || sid == 51 || sid == 61 || sid == 71 || sid == 81 || sid == 91 || sid == 111 || sid == 1) {
            //    if (chkbox.checked) {
            //    $('.chkotherfeer').prop('disabled', true);
            //    }else{
            //       $('.chkotherfeer').prop('disabled', false);
            //    }
            ...
            if (sid == 1) {
               ...
               if (chkbox.checked) {
                  $('input[id^="s1-"]').prop('disabled', true);
                  $('input[id^="chk1-"]').prop('disabled', true);
                  $('input[id^="s2-"]').prop('disabled', false);
                  $('input[id^="chk2-"]').prop('disabled', false);
                  $('input[id^="s3-"]').prop('disabled', true);
                  $('input[id^="chk3-"]').prop('disabled', true);
                  $('input[id^="s4-"]').prop('disabled', true);
                  $('input[id^="chk4-"]').prop('disabled', true);

                  $('.paper').prop('disabled', true);
                  $('.news').prop('disabled', true);
                  $('.transclass').prop('disabled', true);
                  $('.chkotherfeer').prop('disabled', true);
                  $('.StuAttendCkrg').prop('disabled', true);

                  $('.1tutuion').prop('checked', false);
                  $('.news').prop('checked', false);
                  $('.transclass').prop('checked', false);
                  $('.chkotherfeer').prop('checked', false);
                  $('.StuAttendCkrg').prop('checked', false);

                  $('.tamount').text(0);
               } else {
                  $('.quaclass').prop('disabled', false);
                  $('.paper').prop('disabled', false);
                  $('.news').prop('disabled', false);
                  $('.transclass').prop('disabled', false);
                  $('.chkotherfeer').prop('disabled', false);
                  $('.StuAttendCkrg').prop('disabled', false);
               }
               ...
               if (selec.split(' ').includes('transclass')) {
                  if (chkbox.checked) {
                     ...
                     $('.paper').prop('disabled', true);
                     $('.news').prop('disabled', true);
                     $('.quaclass').prop('disabled', true);
                     $('.chkotherfeer').prop('disabled', true);
                     $('.StuAttendCkrg').prop('disabled', true);

                     $('.news').prop('checked', false);
                     $('.quaclass').prop('checked', false);
                     $('.chkotherfeer').prop('checked', false);
                     $('.StuAttendCkrg').prop('checked', false);
                  ...
                  if (chkbox.checked) {
                     $('input[id^="s1-"]').prop('disabled', true);
                     $('input[id^="chk1-"]').prop('disabled', true);
                     $('input[id^="s2-"]').prop('disabled', true);
                     $('input[id^="chk2-"]').prop('disabled', true);
                     $('input[id^="s3-"]').prop('disabled', false);
                     $('input[id^="chk3-"]').prop('disabled', false);
                     $('input[id^="s4-"]').prop('disabled', true);
                     $('input[id^="chk4-"]').prop('disabled', true);
               ...
               if (selec.split(' ').includes('transclass')) {
                  ...
                  if (chkbox.checked) {
                     ...
                     $('input[id^="s4-"]').prop('disabled', false);
                     $('input[id^="chk4-"]').prop('disabled', false);
                     $('input[id^="s5-"]').prop('disabled', true);
                     $('input[id^="chk5-"]').prop('disabled', true);
                     $('input[id^="s6-"]').prop('disabled', true);
                     $('input[id^="chk6-"]').prop('disabled', true);
               ...
               if (chkbox.checked) {
                  $('input[id^="s4-"]').prop('disabled', true);
                  $('input[id^="chk4-"]').prop('disabled', true);
                  $('input[id^="s5-"]').prop('disabled', false);
                  $('input[id^="chk5-"]').prop('disabled', false);
                  $('input[id^="s6-"]').prop('disabled', true);
                  $('input[id^="chk6-"]').prop('disabled', true);
                  $('input[id^="s7-"]').prop('disabled', true);
                  $('input[id^="chk7-"]').prop('disabled', true);
                  $('input[id^="s8-"]').prop('disabled', true);
                  $('input[id^="chk8-"]').prop('disabled', true);
               ...
               if (chkbox.checked) {
                  ...
                  $('input[id^="s5-"]').prop('disabled', true);
                  $('input[id^="chk5-"]').prop('disabled', true);
                  $('input[id^="s6-"]').prop('disabled', false);
                  $('input[id^="chk6-"]').prop('disabled', false);
                  $('input[id^="s7-"]').prop('disabled', true);
                  $('input[id^="chk7-"]').prop('disabled', true);
                  $('input[id^="s8-"]').prop('disabled', true);
                  $('input[id^="chk8-"]').prop('disabled', true);
               ...
               if (chkbox.checked) {
                  ...
                  $('input[id^="s6-"]').prop('disabled', true);
                  $('input[id^="chk6-"]').prop('disabled', true);
                  $('input[id^="s7-"]').prop('disabled', false);
                  $('input[id^="chk7-"]').prop('disabled', false);
                  $('input[id^="s8-"]').prop('disabled', true);
                  $('input[id^="chk8-"]').prop('disabled', true);
               ...
               if (chkbox.checked) {
                  ...
                  $('input[id^="s7-"]').prop('disabled', true);
                  $('input[id^="chk7-"]').prop('disabled', true);
                  $('input[id^="s8-"]').prop('disabled', false);
                  $('input[id^="chk8-"]').prop('disabled', false);
   ...
   <script type="text/javascript">
      $(function() {
         window.checkpending = function(sid, id, discount) {
            ...
            var ck = 'chk' + sid + '-' + id;
            //   console.log("🚀 ~ file: depositefees.ctp:1634 ~ ck:", ck);return false;
            var cks = 's' + sid + '-' + id;
            var id1 = 'pd' + sid + id;
            var chkbox = document.getElementById(ck);
            var selec = $("#" + ck).attr('class');
            ...
            if (chkbox.checked) {
               for (let i = 10001; i < 10006; i++) {
                  ...
                  $(`input[class*="pendingclass-${i}"]`).prop('disabled', true);
               }
               ...
               if (discount > 0) {
                  ...
                  console.log("🚀 ~ file: depositefees.ctp:1691 ~ idsf:", idsf)
                  $('.tamount').text(idsf);
                  $('.newamnt').text(idsf);
                  var cat = parseInt($('#lfines').val()) + parseInt(idsf);
                  $('.newamnts').val(cat);
         ...
         <div class="col-md-12">
            <div class="box box-info">
               <div class="box-body">
                  ...
                  $boxStyle = 'border-color: #3c8dbc;';
                  if (!empty($students['dropcreated'])) {
                     $boxStyle .= ' background-color: #ff9393;';
                  } else {
                     $boxStyle .= ' background-color: #f2f2f2;';
                  }
                  ?>

                  <div class="box box-solid" style="<?= $boxStyle ?>">
                     <?php if (!empty($students['dropcreated'])): ?>
                        <div style="float: right; padding: 10px; font-weight: bold;">
                           ⚠️ This student is dropped out.
                        </div>
                     <?php endif; ?>
                     ...
                     <div class="box-header left-align text-xs-center">
                        <div class="user-block col-sm-12 no-padding">
                           ...
                           $filename = SITE_URL . 'student/' . $students['file'];
                           $file_headers = get_headers($filename);
                           // pr($students);exit;

                           if ($file_headers && strpos($file_headers[0], '200 OK') && !empty($students['file'])) {
                           ?>
                           ...
                           <span class="username">
                              <a href="<?php echo SITE_URL; ?>admin/students/view/<?php echo $students['id']; ?>">
                                 <?php echo ucfirst($students['fname']); ?>
                                 <?php echo ucfirst($students['middlename']); ?>
                                 <?php echo ucfirst($students['lname']); ?>
                              </a> (<b style="color:green;">
                                 <?php echo $students['enroll']; ?>
                              </b>)
                              <? if ($students['is_transport'] == 'Y') { ?> <i class="fa fa-bus" href="<?php echo SITE_URL; ?>admin/studentfees/is_droptrans/<? echo $students['id']; ?>/<? echo $students['acedmicyear']; ?>" data-target="#globalModaldrop" data-toggle="modal" data-modal-size="modal-lg" aria-hidden="true"> </i>
                              <? } ?>
                           ...
                           <span class="description">
                              ...
                              <?php echo $students['class']['title']; ?> |
                              <strong>Year/Semester </strong> :
                              <?php echo $students['section']['title']; ?> |
                              <strong>Batch </strong> :
                              <?php echo $students['batch']; ?> |
                              <strong>Father Name </strong> :
                              <?php echo $students['fathername']; ?> | <strong>Mobile No. : </strong>
                           ...
                           <div class="text-right">
                              ...
                              if (!empty($findpendings)) {
                                 foreach ($findpendings as $kkt => $rtt) { ?>
                                    <?php $abcObj = new \App\Controller\Admin\ReportController;
                                    $fetchdetail = $abcObj->defaultersearchbyidhistory($rtt['stud_id'], $rtt['acedmicyear']);
                                    if ($fetchdetail != '--') { ?>
                                       <strong class="pull-right" style="color:red; margin-right: -135px;"> Pending Submit? <span class="text-black">₹ </span>
                                          <? echo $fetchdetail; ?>
                                       </strong>
                                    <? } ?>
                                    &nbsp;<a href="<? echo ADMIN_URL; ?>studentfees/view/<? echo $rtt['stud_id']; ?>" class="btn btn-info pull-right" style="margin-left: 15px;">
                                       <? echo $rtt['acedmicyear']; ?>
                                    </a>&nbsp;
                                 <? }
                              } else if ($findpendings23['stud_id']) { ?>
                                 <a href="<? echo ADMIN_URL; ?>studentfees/view/<? echo $findpendings23['stud_id']; ?>" class="btn btn-info pull-right">
              ...
              <a href="<? //echo ADMIN_URL; 
                        ?>studentfees/history/<? //echo $findpendings23['stud_id']; 
                              ...
                              <!-- <?php //if ($students['due_fees'] !== NULL && $students['due_fees'] !== 0) { 
                                    ?>
               <a href="javascript:void(0);" class="btn btn-info " style="color: #fff !important;font-weight: bold;">
               <span class="text-black">Previous Year Due- ₹ </span>
               <span> <?php //echo $students['due_fees']; 
                        ?> </span>
               <span style="color:red;">***</span> 
               </a>
               <input type="hidden" id="due_amount" value="<?php //echo $students['due_fees']; 
                                                            ?>">
            <?php //} 
            ?> -->
                           ...
                           <? if ($students['category'] == "RTE") { ?>
                              ...
                              <span style="font-size:20px;color:red;float: right;font-weight: bold;">***RTE
                                 STUDENT***</span>
                           <? } ?>
                           <? if ($students['category'] == "Migration") { ?>
                              ...
                              <span style="font-size:20px;color:red;float: right;font-weight: bold;">***Migrated
                                 STUDENT***</span>
                           <? } ?>
                        ...
                        <div class="row edusec-user-profile">
                           <div class="col-sm-12">
                              ...
                              <div id="content" class="tab-content responsive ">
                                 ...
                                 <script>
                                    ...
                                    $(function() {
                                       ...
                                       $("#additionaldis").on('change', function() {
                                          ...
                                          //  console.log("🚀 ~ file: depositefees.ctp:1972 ~ $ ~ depositamt:", depositamt)
                                 ...
                                 <script>
                                    document.getElementById('sevice_form').addEventListener('keydown', function(event) {
                                       if (event.keyCode === 13) {
                                 ...
                                 <div class="tab-pane active" id="personal">
                                    ...
                                    <form method="post" enctype="multipart/form-data" accept-charset="utf-8" class="form-horizontal" id="sevice_form" validate="validate" action="<?php echo ADMIN_URL; ?>studentfees/add">
                                       ...
                                       <div class="d-flex" style="justify-content:space-between">
                                          ...
                                          <?php
                                          // pr($rolepresent); die;
                                          $findfeess = $this->Comman->findfees_exist_students($students['id']);
                                          ...
                                          <?php
                                          if ($students['due_fees'] > 0 && $students['due_fees'] !== 0) { ?>
                                             <p class="text-right">
                                                <a href="javascript:void(0);" class="btn btn-info " style="color: #fff !important;font-weight: bold;">
                                                   <span class="text-black">Previous Year Due- ₹ </span>
                                                   <span>
                                                      <?php echo $students['due_fees']; ?>
                                                   </span>
                                                   <span style="color:red;">***</span>
                                                </a>
                                                <input type="hidden" id="due_amount" value="<?php echo $students['due_fees']; ?>">
                                          ...
                                          <div class="col-lg-6">
                                             ...
                                             if ($studentfees2s) {
                                                ...
                                                foreach ($quaflj as $jlj => $tlj) {
                                                   ...
                                                   if ($jlj == "Admission / Prosspectus" || $jlj == "Annual Charges" || $jlj == "Pocket Articles" || $jlj == "Books" || $jlj == "Pocket Articles" || $jlj == "Quater1" || $jlj == "Quater2" || $jlj == "Quater3" || $jlj == "Quate4" || $jlj == "Uniform" || $jlj == "Collage Caution Money (Refundable)" || $jlj == "Enrollment Fees" || $jlj == "Hostel Caution Money" || $jlj == "Transportation Fees" || $jlj == "Library Fees" || $jlj == "ID Card") {
                                                      $qua[] = $jlj;
                                                   }
                                                }
                                             }
                                             ...
                                             if (in_array("Admission / Prosspectus", $qua2s) || in_array("Health Insurance", $qua2s) || in_array("Pocket Articles", $qua2s) || in_array("Collage Caution Money (Refundable)", $qua2s) || in_array("Transportation Fees", $qua2s) || in_array("Health Insurance", $qua2s) || in_array("Library Fees", $qua2s) || in_array("ID Card", $qua2s)) {
                                                ...
                                                if (in_array("Library Fees", $qua2s) && !in_array("Library Fees", $qua)) {
                                                   $qua[] = "Library Fees";
                                                }

                                                if (in_array("ID Card", $qua2s) && !in_array("ID Card", $qua)) {
                                                   $qua[] = "ID Card";
                                                }
                                             }


                                             if (!in_array("Admission / Prosspectus", $qua) || !in_array("Pocket Articles", $qua) || !in_array("Books", $qua) || !in_array("Pocket Articles", $qua) || !in_array("Annual Charges", $qua) || !in_array("Quater1", $qua) || !in_array("Quater2", $qua) || !in_array("Quater3", $qua) || !in_array("Quater4", $qua) || !in_array("ID Card", $qua)) { ?>
                          ...
                          table-responsive" id="mytable">
                                                         ...
                                                         <tbody>
                                                            ...
                                                            <tr class="table_header">
                                                               <th class="bg-teal color-palette" style="width: 5%;"></th>
                                                               <th class="text-left bg-teal color-palette" style="width: 65%;"> Heads </th>
                                                               <th class="text-center bg-teal color-palette" style="width: 30%;"> Fee </th>
                                                            </tr>
                                                            <?php if (isset($classfee) && !empty($classfee)) {
                                                               ...
                                                               foreach ($preclassfee as $krt => $value) {
                                                                  ...
                                                                  // This condition work for old student tution fees hide 
                                                                  // this code comment by sanjay 27-Jun-2024
                                                                  if ($students['admissionyear'] != $students['acedmicyear']) {
                                                                     // if ($students['admissionyear'] < '2023-24') {
                                                                     //     continue;
                                                                     // }
                                                                  }


                                                                  // if($students['section_id'] > 1 && $findfee['type']==2){
                                                                  //    continue;
                                                                  // }

                                                                  //Chech here if student take transport fees
                                                                  // if($students['is_transport']!='Y' && $findfee['name']=='Transportation Fees'){
                                                                  //    continue;
                                                                  // }


                                                                  // pr($findfee);exit;
                                                                  $styles = ($value['qu' . $jk . '_fees'] == null || $value['qu' . $jk . '_fees'] == '0') ? 'style="display: none;"' : '';
                                                                  $findfee['name']; // Retrieve data from the efficient structure

                                                                  // Code to handle checkboxes and texts can be combined into one block
                                                                  if (!in_array($findfee['name'], $qua) && !in_array($findfee['name'], $qua2)) {

                                                                     $chkClass = ($findfee['name'] == "Collage Caution Money (Refundable)" || $findfee['name'] == "Hostel Caution Money") ? 'StuAttendCks paper' : 'StuAttendCk imp news';
                                                                     // pr($findfee['name']);exit;
                                                            ?>
                                                                     <tr <?php echo $styles; ?>>
                                                                        ...
                                                                        <td>
                                                                           ...
                                                                           <!-- This condition for Caution Money  -->
                                                                           <?php if ($chkClass == 'StuAttendCks paper') { ?>

                                                                              <label>
                                                                                 <input type="checkbox" id="chk<?php echo $y . $jk . '-' . $value['qu' . $jk . '_fees']; ?>" class="<?php echo $chkClass; ?>" name="amount[]" onclick="checkpaper(<?php echo $y . $jk . ',' . $value['qu' . $jk . '_fees'] . ',' . $discount_fees . ',0'; ?>)" value="<?php echo $value['qu' . $jk . '_fees']; ?>">
                                                                              </label>


                                                                           <?php } else { ?>

                                                                              <input type="checkbox" id="chk<?php echo $y . $jk . '-' . $value['qu' . $jk . '_fees']; ?>" class="<?php echo $chkClass; ?>" name="amount[]" onclick="check(<?php echo $y . $jk . ',' . $value['qu' . $jk . '_fees'] . ',' . $discount_fees . ',0'; ?>)" value="<?php echo $value['qu' . $jk . '_fees']; ?>">
                                                                              </label>
                                                                        ...
                                                                        <td>
                                                                           <input type="text" style="background-color: transparent; border: none;width: 100%;" name="quater[]" id="s<?php echo $y . $jk . '-' . $value['qu' . $jk . '_fees']; ?>" class="quatyid" value="<?php echo $findfee['name']; ?>" readonly disabled="">
                                                                           <input type="hidden" class="fehaedf" style="background-color: transparent; border: none;" id="sp<?php echo $y . $jk . '-' . $value['qu' . $jk . '_fees']; ?>" value="<?php echo $findfee['id']; ?>" readonly disabled="">
                                                                        </td>
                                                            ...
                                                            <!-- Quater fees Show here start  -->
                                                            <?php
                                                            $tuitionFees = $classfee[0]; //Tution Fees Comes
                                                            $transportFees = $classfee[1]; // Tranport Fees Comes
                                                            $tutionfeesyearly = 0;
                                                            $transportfeesyearly = 0;
                                                            $i = 1;
                                                            $u = 1;
                                                            //   pr($totalSections);exit;
                                                            // for ($i; $i <= $totalSections; $i++) {
                                                            for ($i; $i <= $totalSections; $i++) {


                                                               $tutionfeesyearly = $tuitionFees['qu' . $i . '_fees'];

                                                               $quarterLabel = '';
                                                               if ($i == 1) {
                                                                  $quarterLabel = $i . 'st Year Tuition Fee';
                                                               } elseif ($i == 2) {
                                                                  $quarterLabel = $i . 'nd Year Tuition Fee';
                                                               } elseif ($i == 3) {
                                                                  $quarterLabel = $i . 'rd Year Tuition Fee';
                                                               } else {
                                                                  $quarterLabel = $i . 'th Year Tuition Fee';
                                                               }


                                                               // $showRow = !in_array('Quater' . $i, $qua) && !in_array('Quater' . $i, $qua2);

                                                               // // Hide row for old students' tuition fees
                                                               // $showRow = $showRow && ($students['admissionyear'] == $students['acedmicyear']);


                                                               $showRow = true;
                                                               if (in_array('Quater' . $i, $qua) || in_array('Quater' . $i, $qua2)) {
                                                                  $showRow = false;
                                                               }
                                                               // for skip semester
                                                               if ($tutionfeesyearly == '') {
                                                               ...
                                                               if ($showRow) { ?>
                                                                  ...
                                                                  <tr>
                                                                     ...
                                                                     <td style="width: 4px;">
                                                                        <label>
                                                                           <input type="checkbox" id="chk<?php echo $i; ?>-<?php echo $tutionfeesyearly; ?>" class="StuAttendCk lnm quaclass <?php echo $i; ?>tutuion" name="amount[]" onclick="check(<?php echo $i; ?>,<?php echo $tutionfeesyearly; ?>,<?php echo $discount_fees; ?>)" value="<?php echo $tutionfeesyearly; ?>">
                                                                        </label>
                                                                     </td>
                                                                     <td>
                                                                        <input type="text" style="background-color: transparent;border: none;" value="<?php echo $quarterLabel; ?>" readonly>
                                                                        <input type="hidden" style="background-color: transparent;border: none;width: 100%;" name="quater[]" id="s<?php echo $i; ?>-<?php echo $tutionfeesyearly; ?>" class="quatyid" value="Quater<?php echo $i; ?>" readonly disabled="">
                                                                        <input type="hidden" class="fehaedf" style="background-color: transparent;border: none;" id="sp<?php echo $i; ?>-<?php echo $tutionfeesyearly; ?>" value="2" readonly disabled="">
                                                                     </td>

                                                                     <td align="center">
                                                                        <span class="text-black">&#8377;</span>
                                                                        <input type="text" style="width: 34%;" maxlength="6" minlength="1" readonly="readonly" class="amounedit" name="amountl[]" id="amoun<?php echo $y; ?>" value="<?php echo $tutionfeesyearly; ?>">&nbsp;&nbsp;
                                                                        <a href="javascript:void(0);" class="remove_special" style="font-weight: bold; font-size: 16px;color:red;display:none;"><i class="fa fa-times"></i></a>
                                                                     </td>
                                                                  </tr>
                                                            ...
                                                            // <!-- Quater fees Show here end  -->

                                                            $hideShowRow = true;
                                                            // <!-- transport fees Show here start  -->
                                                            //Chech here if student take transport fees
                                                            // pr($students['is_transport']);die;
                                                            if ($students['is_transport'] === 'Y') {
                                                               // echo "fsdfsf"; die;
                                                               // for ($u; $u <= $students['section_id']; $u++) {
                                                               for ($u; $u <= 4; $u++) {

                                                                  $transportfeesyearly = $transportFees['qu' . $u . '_fees'];
                                                                  if ($transportfeesyearly == 0) {
                                                                     continue;
                                                                  }
                                                                  // pr($transportfeesyearly);exit;
                                                                  if ($u == 1) {
                                                                     $quarterLabel = $u . 'st Year Transport Fee';
                                                                  } elseif ($u == 2) {
                                                                     $quarterLabel = $u . 'nd Year Transport Fee';
                                                                  } elseif ($u == 3) {
                                                                     $quarterLabel = $u . 'rd Year Transport Fee';
                                                                  } else {
                                                                     $quarterLabel = $u . 'th Year Transport Fee';
                                                                  }
                                                                  $hideShowRow = true;

                                                                  if (in_array('Transport' . $u, $qua) || in_array('Transport' . $u, $qua2)) {
                                                                     // echo "dsfsfs"; die;
                                                                     $hideShowRow = false;
                                                                  }
                                                                  ...
                                                                  if ($hideShowRow) { //echo "sanjay"; die;
                                                               ?>

                                                                     <tr>
                                                                        <td style="width: 4px;">
                                                                           <label>
                                                                              <input type="checkbox" id="chk<?php echo $i; ?>-<?php echo $transportfeesyearly; ?>" class="StuAttendCk lnm transclass" name="amount[]" onclick="check(<?php echo $i; ?>,<?php echo $transportfeesyearly; ?>,<?php echo $discount_fees; ?>)" value="<?php echo $transportfeesyearly; ?>">
                                                                           </label>
                                                                        </td>
                                                                        <td>
                                                                           <input type="text" style="background-color: transparent;border: none;" value="<?php echo $quarterLabel; ?>" readonly>
                                                                           <input type="hidden" style="background-color: transparent;border: none;width: 100%;" name="quater[]" id="s<?php echo $i; ?>-<?php echo $transportfeesyearly; ?>" class="quatyid" value="Transport<?php echo $u; ?>" readonly disabled="">
                                                                           <input type="hidden" class="fehaedf" style="background-color: transparent;border: none;" id="sp<?php echo $i; ?>-<?php echo $transportfeesyearly; ?>" value="2" readonly disabled="">
                                                                        </td>

                                                                        <td align="center">
                                                                           <span class="text-black">&#8377;</span>
                                                                           <input type="text" style="width: 34%;" maxlength="6" minlength="1" readonly="readonly" class="amounedit" name="amountl[]" id="amoun<?php echo $y; ?>" value="<?php echo $transportfeesyearly; ?>">&nbsp;&nbsp;
                                                                           <a href="javascript:void(0);" class="remove_special" style="font-weight: bold; font-size: 16px;color:red;display:none;"><i class="fa fa-times"></i></a>
                                                                        </td>
                                                                     </tr>
                                                ...
                                                <script>
                                                   ...
                                                   $(function() {
                                                      window.chkotherfsees = function(sid) {
                                                         ...
                                                         // console.log("🚀 ~ file: depositefees.ctp:2320 ~ opt:", opt);

                                                         if (opt == 57) {
                                                            $('#forpreviouseyear').show();
                                                         ...
                                                         $.ajax({
                                                            ...
                                                            success: function(data) {
                                                               // 57 id is fees head id for previous year due 
                                                               if (opt == 57) {
                                                                  data = parseInt(dueAmount);
                                                               } else {
                                                                  data = parseInt(data);
                                                               }
                                                   ...
                                                   <table class="table table-striped table-hover table-condensed table-responsive" id="mytable">
                                                      <tbody>
                                                         <tr class="table_header">
                                                            ...
                                                            <th style="width: 27%;" class="bg-teal color-palette">Reference
                                                               No.</th>
                                                         ...
                                                         <? if ($studentfeesk) {
                                                            $quass = array();
                                                            $totalRecords = count($studentfeesk);
                                                            foreach ($studentfeesk as $numKey => $valsf) {
                                                               ...
                                                               <tr>
                                                                  ...
                                                                  <td>
                                                                     ...
                                                                     <? } else { ?>
                                                                        <!-- <a title="Print Receipt" target="_blank" href="<? //echo ADMIN_URL; 
                                                                                                                              ?>studentfees/newprintsadmission/<?php //echo $valsf['id']; 
                                                                                                                                                               ?>/<?php //echo $academic_year; 
                                                                                                                                                                  ?>"><i class="fa fa-file-text-o"></i></a> -->

                                                                        <a title="Print Receipt" target="_blank" href="<? echo ADMIN_URL; ?>studentfees/newprintsadmission/<?php echo $valsf['id']; ?>"><i class="fa fa-file-text-o"></i></a>
                                                                     <? } ?>

                                                                     <?php
                                                                     // pr($rolepresent); die;
                                                                     if ($rolepresent == 1) {
                                                                        $checkpendingreceipt = $this->comman->checkpendingreceipt($valsf['id'], $students['id'], $valsf['quarter_name']);
                                                                        // if ($numKey === $totalRecords - 1) { // Check if this is the last record 

                                                                        if (empty($checkpendingreceipt)) { // Check if this is the last receipt 
                                                                     ?>
                                                                           <a title="Cancel Receipt" class="modalcancel" data-toggle="modal" data-val="<?php echo $valsf['id']; ?>" data-id="<?php echo $valsf['recipetno']; ?>" data-options="<?php echo $academic_year; ?>" data-target="#myModal"><i class="fa fa-remove"></i></a>
                                                                     <?php }
                                                                     } ?>
                                                ...
                                                <div class="table-responsive">
                                                   <table class="table table-striped table-hover table-condensed table-responsive" id="mytable">
                                                      <tbody>
                                                         <tr class="table_header">
                                                            <th class="bg-teal color-palette"></th>
                                                            <th style="width: 27%;" class="bg-teal color-palette">Before
                                                               Migration Reference No.<br>(In Current Year)</th>
                                                            <th class="text-left bg-teal color-palette">Paydate </th>
                                                            <th class="text-left bg-teal color-palette"> Amount </th>
                                                            <th class="text-left bg-teal color-palette"> Print </th>
                                                         </tr>
                                                   ...
                                                   <? if (isset($student_dataftf) && !empty($student_dataftf)) { ?>
                                                      <table class="table table-striped table-hover table-condensed table-responsive">
                                                         <tbody>
                                                            <tr>
                                                               <th class="bg-teal color-palette"></th>
                                                               <th style="width: 27%;" class="bg-teal color-palette">Sibling's
                                                                  Detail </th>
                                                            ...
                                                            ?>
                                                               ...
                                                               <td colspan="8" style="text-align:center;">No Siblings data find
                                                               </td>
                                                            <?php } ?>
                                                      </table>
                                                   <?php } ?>
                                             ...
                                             <div class="table-responsive">
                                                <table class="table table-striped table-hover table-condensed table-responsive" id="mytable">
                                                   <tbody>
                                                      <tr class="table_header">
                                                         <th class="bg-teal color-palette"></th>
                                                         <th style="width: 25%;" class="bg-teal color-palette">
                                                            Description</th>
                                                      ...
                                                      <?
                                                      //  $nk = '51';
                                                      $nk = 10001; //replace this condition by Rupam 05/08/2023
                                                            ...
                                                            if ($sert) { ?>
                                                               <tr>
                                                                  <td style="width:4px;">
                                                                     ...
                                                                     <label>
                                                                        <input id="chk<?php echo $nk; ?>-<?php echo round($val['amt']); ?>" class="StuAttendCkrg pendingclass-<?php echo $nk; ?>" name="amounts[<?php echo $k; ?>]" onclick="checkpending(<?php echo $nk; ?>, <?php echo round($val['amt']); ?>, 0)" value="<?php echo $val['amt']; ?>" type="checkbox">
                                                                     </label>
                                                                  ...
                                                                  <td style="width:4px;">
                                                                     <label><input name="student_id" value="<?php echo $val['s_id']; ?>" type="hidden">
                                                                        ...
                                                                        Pending As Per Reference No
                                                                        <?php echo $val['recipetnos']; ?> </label>
                                                                  </td>
                                                                  ...
                                                                  <td class="text-right"><? if ($val['amt'] < 0) { ?> Extra Paid
                                                                     <? } else { ?> Pending<?php } ?>
                                                                  </td>
                                                      ...
                                                      <?php if (isset($classfee) && !empty($classfee)) { ?>
                                                         <div>
                                                            <tr class="assets_container">
                                                               ...
                                                               <td class="col-sm-2" width="10%" class="subtype" style="position:relative;">
                                                                  <label></label>
                                                         ...
                                                         <script>
                                                            $(document).ready(function() {
                                                               ...
                                                               $(".add_field_butto").click(function() {
                                                                  $('.after-add-more').append('<tr class="assets_container asset2"><td colspan="4" width="45%"><b>Other Fee Charge : &nbsp; </b><select name="quater[]" id="chkotherfee' + x + '"  class="chkotherfeer" onchange="chkotherfseesj(' + x + ');"><option value="">- Add Other Fee -</option><? foreach ($feesheadstotal as $ky => $item) { ?>  <option value="<?php echo $item["id"]; ?>"><?php echo $item["name"]; ?></option> <? } ?></select></td><td colspan="2" width="45%"><b><br> </b><input name="amount[]" readonly="readonly" id="otherfeeamts' + x + '" value="" placeholder="Enter Amount" type="number"> </td><td class="col-sm-2" class="subtype" style="position:relative;" ><label></label><a href="javascript:void(0);" class="remove" id="removes' + x + '" onclick="calculatremain(' + x + ')" style="font-weight: bold; font-size: 17px;margin-top: 6px;position: absolute;"><i class="fa fa-minus-circle"></i></a> </td></tr>');
                                                                  x++;
                                                               });
                                ...
                                <? //$newt = $student_datasm;
                                                         //if ($newt) {  
                                 ?>
                                <input name="recipetno" type="text" value="<? //echo $newt; 
                                                                           ?>" class="form-control" readonly="readonly" required="required" id="recipitno" maxlength="9" placeholder="Enter Receipt No. Here">
                                <? //} else { 
                                 ?>
                                 ...
                                 ?>
                                                         ...
                                                         <tr>
                                                            <td colspan="8" width="50%">
                                                               <b style=" display:block;">Mode :</b>
                                                               <span>&nbsp;&nbsp;&nbsp;&nbsp;<label class="radio-inline"><input type="radio" required id="radio1" name="mode" checked="checked" value="CASH" onclick="return checks(this);">Cash</label>
                                                                  ...
                                                                  <label class="radio-inline"><input type="radio" required id="radio1" name="mode" value="Credit Card/Debit Card/UPI" onclick="return checks(this);">Credit Card/Debit
                                                                     Card/UPI</label>
                                                               </span>
                                                            </td>
                                                         </tr>
                                                            ...
                                                            <td colspan="4" width="50%">
                                                               ...
                                                               <select name="discountcategory" required="required" id="chkdiscountcateg">
                                                                  ...
                                                                  <?php foreach ($discountCategorylist as $ky => $item) { ?>
                                                                     <option value="<?php echo $item['id']; ?>" <?php if ($item['name'] == $discoutcatryys) { ?> selected="selected" <? } ?>>
                                                                        <?php echo $item['name']; ?>
                                                                     </option>
                                                                  <?php } ?>
                                                               </select>
                                  ...
                                  stuattendance-sa_date " readonly="readonly" name="paydate" maxlength="50" placeholder="Enter Paydate" value="<? echo date('d-m-Y'); ?>" required="">
                                                         ...
                                                         <tr>
                                                            ...
                                                            <td colspan="4">
                                                               <b>(-)Add. Discount :&nbsp; </b>
                                                               <span class="text-black">&#8377; </span>
                                                               <input type="number" placeholder="Additional Discount" onchange="checkAdditionalDiscount();" min="0" id="additionaldis" name="addtionaldiscount" value="0" style="width: 42%;" maxlength="10">
                                                         ...
                                                         <tr>
                                                            ...
                                                            <td colspan="4">
                                                               <b>Deposit Amount :&nbsp; <span class="text-black">&#8377;
                                                                  </span> </b>
                                                               <input name="deposite_amt" class="newamnts" onchange="checkDepositAmount(this.value);" id="depositamt" style="width: 43%;" placeholder="Deposit Amount" required type="number">
                                                            </td>
                                                         </tr>
                                                         ...
                                                         <tr>
                                                            <td colspan="4">
                                                               <b>Due Amount :&nbsp;</b><span id="sum1"></span>
                                                               <input type="hidden" id="dueextras" name="dueextra">
                                                            </td>
                                                         </tr>

                                                         <script>
                                                            function checkAdditionalDiscount() {
                                                               var depositInput = document.getElementById('depositamt');
                                                               var depositAmount = parseFloat(depositInput.value);

                                                               var netAmount = parseFloat($('.afdiscount').val()); // Net Amount
                                                               var additionalDiscount = parseFloat($('#additionaldis').val()); // additional amount

                                                               var totalEligibleDeposit = netAmount - additionalDiscount;
                                                               // console.log("🚀 ~ file: depositefees.ctp:4915 ~ checkDepositAmount ~ totalEligibleDeposit:", totalEligibleDeposit)

                                                               // if (additionalDiscount > netAmount) {
                                                               //    $('#additionaldis').val('0'); // Reset additional discount value
                                                               //    depositInput.value = ''; // Reset deposit amount value
                                                               //    $('#sum1').text(''); // Reset the content of the span
                                                               //    $('#dueextras').val('0');
                                                               //    alert('Additional Discount cannot be greater than the Net Amount.');
                                                               // }
                                                            }
                                                            ...
                                                            function checkDepositAmount(amount) {
                                                               ...
                                                               var totalEligibleDeposit = netAmount - additionalDiscount;
                                                               // console.log("🚀 ~ file: depositefees.ctp:4915 ~ checkDepositAmount ~ totalEligibleDeposit:", totalEligibleDeposit)
                                                               // if (depositAmount > totalEligibleDeposit) {
                                                               //    depositInput.value = ''; // Reset deposit amount value
                                                               //    $('#sum1').text(''); // Reset the content of the span
                                                               //    $('#dueextras').val('0');
                                                               //    alert('Do not enter an amount greater than the discount value.');
                                                               // }
                                                            }
                                                         </script>
                                                         ...
                                                         <tr>
                                                            ...
                                                            <td colspan="4" id="ref" style="display:none;">
                                                               <b>Reference No. :&nbsp; </b>
                                                               <input type="text" id="refno" style="max-width: 152px;" placeholder="Reference Number" name="ref_no">
                                                            </td>
                                                         </tr>
                                                      ...
                                                      <tr>
                                                         <td colspan="8"><label>Remarks :</label>
                                                            <textarea name="remarks" class="form-control rounded-0 capitalize-word" id="exampleFormControlTextarea2" placeholder="Enter Remarks Here" rows="3"></textarea>
                                                            <input type="hidden" name="student_id" value="<?php echo $students['id']; ?>">
                                                         </td>
                                                      </tr>

                                                      <tr id="forpreviouseyear">
                                                         <td colspan="8">
                                                            <label>Choose Heads (Hold CTRL to select multiple
                                                               options):</label>
                                                            <select name="forpreviouseyear[]" class="form-control" multiple style="height: 150px;">
                                                               <?php foreach ($completeFeesheads as $feesHeadIndex => $feesheadName) { ?>
                                                                  <option value="<?php echo $feesheadName; ?>">
                                                                     <?php echo $feesheadName; ?>
                                                                  </option>
                                                               <?php } ?>
                                                            </select>
                                                         </td>
                                       ...
                                       <!-- <div class="table-responsive">
                                          <table class="table table-striped table-hover" id="mytable">
                                             <tbody>
                                                <tr class="table_header">
                                                   <th style="text-align:center;"> No Fees Structure for RTE Student!!
                                                   </th>
                                                </tr>
                                             </tbody>
                                          </table>
                                             ...
                                             <form method="post" enctype="multipart/form-data" accept-charset="utf-8" class="form-horizontal" id="sevice_formtest" validate="validate" action="<? echo ADMIN_URL; ?>studentfees/cancelledstudent">
                                                ...
                                                <div class="modal-content">
                                                   <div class="modal-header" style="background-color: #3c8dbc;">
                                                      ...
                                                      <h4 class="modal-title">Are You Sure ? Do You Want To Cancel This
                                                         Reference No. <b class="ert"> </b></h4>
                                                   </div>
