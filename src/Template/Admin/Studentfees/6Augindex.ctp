...
none;" name="quater[]" id="s<?php echo $i; ?><?php echo $classfee[0]['qu' . $i . '_fees']; ?>" class="quatyid" value="Quater<?php echo $i; ?>" readonly disabled="">
																			...
																			<div>
																				<tr class="assets_container">
																					<td colspan="4" width="50%">
																						...
																						<b>Other Fee Charge : &nbsp; </b><select name="quater[]" id="chkotherfee" onChange="chkotherfsees('chkotherfee');">
		...
		$('.afdiscount').val(idf); */
																					...
																					<? foreach ($studentfees as $dh => $fdf) {
																						if (isset($fdf['discountcategory'])) {
																							$discoutcatryys = $fdf['discountcategory'];
																						}
																					}
			 ...
			 $("#depositamt").on('blur change', function() {	
																		...
																		<tr>
																			...
																			foreach ($studentfees as $h => $ff) {
																				if (isset($ff['discountcategory'])) {
																					$discoutcatryy = $ff['discountcategory'];
																				}
																			}

																			if ($discoutcatryy == '') {
																				if ($students['discountcategory'] != '') {
																					$discoutcatryy = $students['discountcategory'];
																				}
																			}

																			if ($discoutcatryy != '') { ?>
																				<td colspan="4" width="50%">
																					<b>Discount Taken :</b> <? if ($discoutcatryy) {
																												echo " " . $discoutcatryy;
																											} elseif ($discoutcatryy) {
																												echo " " . $discoutcatryy;
																											} ?>
