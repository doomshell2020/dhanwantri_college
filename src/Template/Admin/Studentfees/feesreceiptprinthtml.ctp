...
// if ($get_managesettings['logo_type'] == '1') {
//     $logo  = "images/" . $sitesetting['header_logo'];
// } else {
// }
...
<td width="100%" style="border:1px solid #000; ">
 <div style="height:6px; line-height:5px;padding-top: 3px;"> ';
...
if ($rtt == '1') {
    ...
    if ($lastdatemonthw) {
        ...
        // } else {
        //     $html .= '&nbsp;Next Due on 10, ' . $dateg . ' after Due Date Rs. 10 per day fine will be charged.&nbsp;Amount once deposited &nbsp; <br> will not be refunded.';
        // }
    } else {
        $html .= '&nbsp;&nbsp;Amount once deposited will not be refunded.';
    }
...
<td width="100%" style="height:15px; line-height:15px; text-align:right; font-size:9px;">Principal/Accountant Signature &nbsp;</td>
...
$html .= '</div><div style="height:10px; line-height:7px;padding-top: 21px;"> &nbsp;Remarks :&nbsp;' . wordwrap(ucfirst(strtolower($studentfees['remarks'])), 80, "&nbsp;&nbsp;") . '</div>
 <div style="height:10px; line-height:4px;"> </div>
