...
<?php
// pr($db);exit;
$admission_year_st  = $students['acedmicyear'];
$admission_year_user  = $db['academic_year'];
// pr($admission_year_st);
// pr($students);exit;
?>
                                             ...
                                             <div class="col-lg-6">
                                                ...
                                                if ($studentfees2s) {
                                                   ...
                                                   foreach ($quaflj as $jlj => $tlj) {
                                                      if ($jlj == "Admission Fee" || $jlj == "Annual Charges" ||  $jlj == "Development Fee" || $jlj == "Caution Money" || $jlj == "Miscellaneous Fee" || $jlj == "Quater1" || $jlj == "Quater2" || $jlj == "Quater3" || $jlj == "Quate4") {
                                                         $qua[] = $jlj;
                                                      }
                                                   }
                                                }
                                                ...
                                                if (in_array("Admission Fee", $qua2s) || in_array("Annual Charges", $qua2s) || in_array("Development Fee", $qua2s) || in_array("Caution Money", $qua2s)) {

                                                   if (in_array("Admission Fee", $qua2s) &&  !in_array("Admission Fee", $qua)) {

                                                      $qua[] = "Admission Fee";
                                                   }


                                                   if (in_array("Annual Charges", $qua2s) &&  !in_array("Annual Charges", $qua)) {

                                                      $qua[] = "Annual Charges";
                                                   }

                                                   if (in_array("Development Fee", $qua2s) &&  !in_array("Development Fee", $qua)) {

                                                      $qua[] = "Development Fee";
                                                   }

                                                   if (in_array("Caution Money", $qua2s) &&  !in_array("Caution Money", $qua)) {
                                                ...
                                                if (!in_array("Admission Fee", $qua) || !in_array("Development Fee", $qua) || !in_array("Caution Money", $qua)  || !in_array("Miscellaneous Fee", $qua) || !in_array("Annual Charges", $qua)  || !in_array("Quater1", $qua)  || !in_array("Quater2", $qua) || !in_array("Quater3", $qua) || !in_array("Quater4", $qua)) { ?>
                                       ...
                                       table-responsive" id="mytable">
                                                            ...
                                                            <tbody>
                                                               ...
                                                               ?>
                                                                     <tr <?php echo $styles; ?>>
                                                                        ...
                                                                        // pr($findfee); die;
                                                                        ?>
                                                                        <? if ($findfee['name'] == "Annual Charges") {
                                                                           if ((!in_array("Annual Charges", $qua)) && (!in_array("Annual Charges", $qua2))) {   ?>
                                                                           ...
                                                                           <? }
                                                                        } else if ($findfee['name'] == "Admission Fee") {
                                                ...
                                                transparent;border: none;" name="quater[]" id="s<? echo $y; ?><? echo $jk; ?>-<?php echo $value['qu' . $jk . '_fees']; ?>" class="quatyid" value="<? echo $findfee['name']; ?>" readonly disabled="">
                                                   ...
                                                   16px;color:red;display:none;"><i class="fa fa-times"></i></a>
                                                                           ...
                                                                           if ((!in_array("Admission Fee", $qua)) && (!in_array("Admission Fee", $qua2))) {   ?>
                                                                              <?php if ($admission_year_st == $admission_year_user) {  ?>
                                                                                 <td align="center"><span class="text-black">&#8377; </span><?php if ($dat != '1970-01-01') { //echo number_format($value['qu'.$jk.'_fees']);
                                                                                                                                             ?>
                                                                                       <input type="text" name="amountl[]" style="width: 34%;" maxlength="6" minlength="1" id="amoun1" readonly="readonly" class="amounedit" value="<? echo $value['qu' . $jk . '_fees']; ?>">&nbsp;&nbsp;
                                                                                       <a href="javascript:void(0);" class="remove_special" style="font-weight: bold; font-size:
                                                   16px;color:red;display:none;"><i class="fa fa-times"></i></a>
                                                                                                   ...
                                                                                                   <? } else  if ($i == 4) { ?>
                                                                                                      ...
                                                                                                      ?>
                                                                                                            ...
                                                                                                            if ($i == 1) {
                                                                                                               if (!in_array("Quater" . $i, $qua)) {  ?>
                                                                                                                  <td>
                                                                                                                     <input type="text" style="background-color: transparent;border: none;" value="Tuition Fee (1st-Year)" readonly>
                                                ...
                                                none;" name="quater[]" id="s<?php echo $i; ?>-<?php echo $classfee[0]['qu' . $i . '_fees']; ?>" class="quatyid" value="Quater<?php echo $i; ?>" readonly disabled="">
                                                                                                               ...
                                                                                                               if (!in_array("Quater" . $i, $qua)) {  ?>
                                                                                                                  <td>
                                                                                                                     <input type="text" style="background-color: transparent;border: none;" value="Tuition Fee (2nd Year.)" readonly>
                                                                                                                     <?php if (!in_array("Quater" . $i, $qua)) {  ?>
                                                                                                                        <input type="hidden" style="background-color: transparent;border:
                                                none;" name="quater[]" id="s<?php echo $i; ?>-<?php echo $classfee[0]['qu' . $i . '_fees']; ?>" class="quatyid" value="Quater<?php echo $i; ?>" readonly disabled="">
                                                                                                                        <input type="hidden" class="fehaedf" style="background-color: transparent;border: none;" id="sp<?php echo $i; ?>-<?php echo $classfee[0]['qu' . $i . '_fees']; ?>" value="2" readonly disabled="">
                                                                                                               ...
                                                                                                               if (!in_array("Quater" . $i, $qua)) { ?>
                                                                                                                  <td>
                                                                                                                     <input type="text" style="background-color: transparent;border: none;" value="Tuition Fee (3rd Year.)" readonly>
                                                                                                                     <?php if (!in_array("Quater" . $i, $qua)) {  ?>
                                                                                                                        <input type="hidden" style="background-color: transparent;border:
                                                none;" name="quater[]" id="s<?php echo $i; ?>-<?php echo $classfee[0]['qu' . $i . '_fees']; ?>" class="quatyid" value="Quater<?php echo $i; ?>" readonly disabled="">
                                                                                                                        <input type="hidden" class="fehaedf" style="background-color: transparent;border: none;" id="sp<?php echo $i; ?>-<?php echo $classfee[0]['qu' . $i . '_fees']; ?>" value="2" readonly disabled="">
                                                                                                               ...
                                                                                                               if (!in_array("Quater" . $i, $qua)) { ?>
                                                                                                                  <td>
                                                                                                                     <input type="text" style="background-color: transparent;border: none;" value="Tuition Fee (4th Year)" readonly>
                                                                                                                     <?php if (!in_array("Quater" . $i, $qua)) {  ?>
                                                                                                                        <input type="hidden" style="background-color: transparent;border:
                                                none;" name="quater[]" id="s<?php echo $i; ?>-<?php echo $classfee[0]['qu' . $i . '_fees']; ?>" class="quatyid" value="Quater<?php echo $i; ?>" readonly disabled="">
                                                                                                                        <input type="hidden" class="fehaedf" style="background-color: transparent;border: none;" id="sp<?php echo $i; ?>-<?php echo $classfee[0]['qu' . $i . '_fees']; ?>" value="2" readonly disabled="">
                                                                                                               ...
                                                                                                               $currentdoate = strtotime(date('d-m-Y'));
                                                                                                               $clodate = strtotime(date('Y-m-d', strtotime(strtotime($transportfees['fee_sub_q1']))));
                                                                                                               ?>
                                                                                                               <?php if (!in_array("Transport" . $i, $qua)) {  ?>
                                                                                                                  <td>
                                                                                                                     <input type="text" style="background-color: transparent;border: none;" value="Transport Fee (APRIL-JUNE)" readonly>
                                                                                                                     <?php //pr($qua); die; 
                                                                                                                     ?>
                                                                                                                     <?php if (!in_array("Transport" . $i, $qua)) {  ?>
                                                                                                                        <input type="hidden" style="background-color: transparent;border:
                                                none;" name="quater[]" id="s<?php echo $i; ?>-<?php echo $transportfees['quarter1']; ?>" class="quatyid" value="Transport<?php echo $i; ?>" readonly disabled="">
                                                                                                                        <input type="hidden" class="fehaedf" style="background-color: transparent;border: none;" id="sp<?php echo $i; ?>-<?php echo $transportfees['quarter1']; ?>" value="2" readonly disabled="">
                                                                                                                     <?php } ?>
                                                                                                                  </td>
                                                                                                               <? }
                                                                                                            } else if ($i == 6) {
                                                                                                               ...
                                                                                                               $currentdoate = strtotime(date('d-m-Y'));
                                                                                                               $clodate = strtotime(date('Y-m-d', strtotime(strtotime($transportfees['fee_sub_q2']))));
                                                                                                               ?>
                                                                                                               <?php if (!in_array("Transport" . $i, $qua)) {  ?>
                                                                                                                  <td>
                                                                                                                     <input type="text" style="background-color: transparent;border: none;" value="Transport Fee (JULY-SEPT.)" readonly>
                                                                                                                     <?php if (!in_array("Transport" . $i, $qua)) {  ?>
                                                                                                                        <input type="hidden" style="background-color: transparent;border:
                                                none;" name="quater[]" id="s<?php echo $i; ?>-<?php echo $transportfees['quarter2']; ?>" class="quatyid" value="Transport<?php echo $i; ?>" readonly disabled="">
                                                                                                                        <input type="hidden" class="fehaedf" style="background-color: transparent;border: none;" id="sp<?php echo $i; ?>-<?php echo $transportfees['quarter2']; ?>" value="2" readonly disabled="">
                                                                                                                     <?php } ?>
                                                                                                                  </td>
                                                                                                               <? }
                                                                                                            } else if ($i == 7) {
                                                                                                               ...
                                                                                                               $currentdoate = strtotime(date('d-m-Y'));
                                                                                                               $clodate = strtotime(date('Y-m-d', strtotime(strtotime($transportfees['fee_sub_q3']))));
                                                                                                               ?>
                                                                                                               <?php if (!in_array("Transport" . $i, $qua)) {  ?>
                                                                                                                  <td>
                                                                                                                     <input type="text" style="background-color: transparent;border: none;" value="Transport Fee (OCT.-DEC.)" readonly>
                                                                                                                     <?php if (!in_array("Transport" . $i, $qua)) {  ?>
                                                                                                                        <input type="hidden" style="background-color: transparent;border:
                                                none;" name="quater[]" id="s<?php echo $i; ?>-<?php echo $transportfees['quarter3']; ?>" class="quatyid" value="Transport<?php echo $i; ?>" readonly disabled="">
                                                                                                                        <input type="hidden" class="fehaedf" style="background-color: transparent;border: none;" id="sp<?php echo $i; ?>-<?php echo $transportfees['quarter3']; ?>" value="2" readonly disabled="">
                                                                                                                     <?php } ?>
                                                                                                                  </td>
                                                                                                               <? }
                                                                                                            } else {
                                                                                                               ...
                                                                                                               $currentdoate = strtotime(date('d-m-Y'));
                                                                                                               $clodate = strtotime(date('Y-m-d', strtotime(strtotime($transportfees['fee_sub_q4']))));
                                                                                                               ?>
                                                                                                               <?php if (!in_array("Transport" . $i, $qua)) {  ?>
                                                                                                                  <td>
                                                                                                                     <input type="text" style="background-color: transparent;border: none;" value="Transport Fee (JAN.-MARCH)" readonly>
                                                                                                                     <?php if (!in_array("Transport" . $i, $qua)) {  ?>
                                                                                                                        <input type="hidden" style="background-color: transparent;border:
                                                none;" name="quater[]" id="s<?php echo $i; ?>-<?php echo $transportfees['quarter4']; ?>" class="quatyid" value="Transport<?php echo $i; ?>" readonly disabled="">
                                                                                                                        <input type="hidden" class="fehaedf" style="background-color: transparent;border: none;" id="sp<?php echo $i; ?>-<?php echo $transportfees['quarter4']; ?>" value="2" readonly disabled="">
                                                                                                                     <?php } ?>
                                                                                                                  </td>
                                                                                                               <? }
                                                                                                            }
                                                                                                            ...
                                                                                                            if ($i == 1) {
                                                                                                               ...
                                                                                                               if (!in_array("Transport" . $i, $qua)) {  ?>
                                                                                                                  <td><?php $dat = date('Y-m-d', strtotime($transportfees['fee_sub_q1']));
                                                                                                                        if ($dat != '1970-01-01') {
                                                                                                                           echo date('d-m-Y', strtotime($dat));
                                                                                                                        } else {
                                                                                                                           echo "not-set";
                                                                                                               ...
                                                                                                               if (!in_array("Transport" . $i, $qua)) {  ?>
                                                                                                                  <td><?php $dat = date('Y-m-d', strtotime($transportfees['fee_sub_q2']));
                                                                                                                        if ($dat != '1970-01-01') {
                                                                                                                           echo date('d-m-Y', strtotime($dat));
                                                                                                                        } else {
                                                                                                                           echo "not-set";
                                                                                                               ...
                                                                                                               if (!in_array("Transport" . $i, $qua)) { ?>
                                                                                                                  <td><?php $dat = date('Y-m-d', strtotime($transportfees['fee_sub_q3']));
                                                                                                                        if ($dat != '1970-01-01') {
                                                                                                                           echo date('d-m-Y', strtotime($dat));
                                                                                                                        } else {
                                                                                                                           echo "not-set";
                                                                                                               ...
                                                                                                               if (!in_array("Transport" . $i, $qua)) {  ?>
                                                                                                                  <td><?php $dat = date('Y-m-d', strtotime($transportfees['fee_sub_q4']));
                                                                                                                        if ($dat != '1970-01-01') {
                                                                                                                           echo date('d-m-Y', strtotime($dat));
                                                                                                                        } else {
                                                                                                                           echo "not-set";
                                                                                                            ...
                                                                                                            if ($i == 1) {
                                                                                                               ...
                                                                                                               if (!in_array("Transport" . $i, $qua)) { ?>
                                                                                                                  <td align="center"><span class="text-black">&#8377; </span><?php
                                                                                                                                                                              ...
                                                                                                                                                                              ?><input type="text" style="width: 34%;" name="amountl[]" id="amoun9" maxlength="6" minlength="1" readonly="readonly" class="amounedit" value="<? echo $transportfees['quarter1']; ?>">&nbsp;&nbsp;
                                                                                                                        <a href="javascript:void(0);" class="remove_special" style="font-weight: bold; font-size: 16px;color:red;display:none;"><i class="fa fa-times"></i></a>
                                                                                                                     <?
                                                                                                                                                                              } else {
                                                                                                                                                                                 echo "not-set";
                                                                                                               ...
                                                                                                               if (!in_array("Transport" . $i, $qua)) { ?>
                                                                                                                  <td align="center"><span class="text-black">&#8377; </span><?php
                                                                                                                                                                              ...
                                                                                                                                                                              ?><input type="text" style="width: 34%;" name="amountl[]" id="amoun10" maxlength="6" minlength="1" readonly="readonly" class="amounedit" value="<? echo $transportfees['quarter2']; ?>">&nbsp;&nbsp;
                                                                                                                        <a href="javascript:void(0);" class="remove_special" style="font-weight: bold; font-size: 16px;color:red;display:none;"><i class="fa fa-times"></i></a>
                                                                                                                     <?
                                                                                                                                                                              } else {
                                                                                                                                                                                 echo "not-set";
                                                                                                               ...
                                                                                                               if (!in_array("Transport" . $i, $qua)) { ?>
                                                                                                                  <td align="center"><span class="text-black">&#8377; </span><?php
                                                                                                                                                                              ...
                                                                                                                                                                              ?><input type="text" style="width: 34%;" name="amountl[]" id="amoun11" maxlength="6" minlength="1" readonly="readonly" class="amounedit" value="<? echo $transportfees['quarter3']; ?>">&nbsp;&nbsp;
                                                                                                                        <a href="javascript:void(0);" class="remove_special" style="font-weight: bold; font-size: 16px;color:red;display:none;"><i class="fa fa-times"></i></a>
                                                                                                                     <?
                                                                                                                                                                              } else {
                                                                                                                                                                                 echo "not-set";
                                                                                                               ...
                                                                                                               if (!in_array("Transport" . $i, $qua)) {
                                                                                                                  ...
                                                                                                                  <td align="center"><span class="text-black">&#8377; </span><?php
                                                                                                                                                                              ...
                                                                                                                                                                              ?><input type="text" style="width: 34%;" name="amountl[]" id="amoun12" maxlength="6" minlength="1" readonly="readonly" class="amounedit" value="<? echo $transportfees['quarter4']; ?>">&nbsp;&nbsp;
                                                                                                                        <a href="javascript:void(0);" class="remove_special" style="font-weight: bold; font-size: 16px;color:red;display:none;"><i class="fa fa-times"></i></a>
                                                                                                                     <?
                                                                                                                                                                              } else {
                                                                                                                                                                                 echo "not-set";
                                                   ...
                                                   <script>
                                                      ...
                                                      $(document).ready(function() {
                                                         ...
                                                         // var locationid = <? //echo $students['location_id']; 
                                                                              ?>
                                                                  ...
                                                                  <tr>
                                                                     ...
                                                                     <td>
                                                                        ...
                                                                        <? } else {  ?>
                                                                           ...
                                                                           <!-- backup 16/05/2022 - rupam  -->
                                                                           <!-- <a title="Print Receipt" target="_blank" href="<? //echo ADMIN_URL; 
                                                                                                                                 ?>studentfees/printsadmission/<?php //echo $valsf['id']; 
                                                                                                                                                               ?>/<?php //echo $academic_year; 
                                                                              ...
                                                                              <!-- <a title="Print Receipt" target="_blank" href="<? //echo ADMIN_URL; 
                                                                                                                                    ?>studentfees/printsadmission/<?php //echo $valsf['id']; 
                                                                                                                                                                  ?>/<?php //echo $academic_year; 
                                                                                                                                                                                          ?>"><i class="fa fa-file-text-o"></i></a> -->
                                                                              <!--
                                                   <a title="Cancel Receipt" class="modalcancel" data-toggle="modal" data-val="<?php //echo $valsf['id']; 
                                                                                                                                 ?>" data-id="<?php //echo $valsf['recipetno']; 
                                                                                                                                                ?>" data-options="<?php //echo $valsf['acedmicyear']; 
                                                                     ...
                                                                     <tr>
                                                                        ...
                                                                        <td><?php $class = $this->Comman->findclasses($s_id);
                                                                              ...
                                                                              ?>-<?php
                                                                                 ...
                                                                                 ?> </td>
                                                                        <td><a title="Deposit-Fees" href="<?php echo SITE_URL; ?>admin/studentfees/view/<?php echo $element['id']; ?>"><img style="width: 22%;" src="<?php echo SITE_URL; ?>images/payment.png"></a></td>
                                                                     </tr>
                                                                  <?php $counter++;
                                                                  }
                                                               } else { ?>
