...
<a href="<?php echo SITE_URL; ?>admin/studattends/export/<?php echo $class_id; ?>/<?php echo $sectionid; ?>/<?php echo $acedmic; ?>/">Click Here For Download CSV Format</a>
		    </div>
            <!-- /.box-header -->
            <!-- form start -->
		...
		<?php echo $this->Form->create($classes, array(
			...
			<?php echo $this->Form->input('file',array('class'=>'form-control','type'=>'file','required', 'id'=>'title','label' =>false)); ?>
		           <input type="hidden" name="acedemic" value="<?php echo $acedmic; ?>">
			...
			echo $this->Html->link('Back', [
			    'action' => 'attendence/'.$class_id.'/'.$sectionid.'/'.$acedmic
