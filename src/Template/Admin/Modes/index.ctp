...
<li><a href="<?php echo ADMIN_URL;?>modes/index">Manage Mode</a></li>
	      </ol>
    </section>
	...
	<div class="box">
            <div class="box-header">
		     ...
		     <div class="box-body">  
<?php echo $this->Form->create($modess, array('url'=>array('controller'=>'modes','action'=>'add'),
		        ...
		        <label class="col-sm-2">Mode Name<span style="color:red;">*</span></label>
		         <div class="col-sm-5">
		<?php echo $this->Form->input('name',array('class'=>'form-control','placeholder'=>'Mode Name','required'=>true, 'id'=>'title','label' =>false)); ?>
		          </div>	             
...
<?php echo $this->Form->end(); ?>  
		     ...
		     <div class="box-body">    
		      <h3 class="box-title">Mode List</h3>
