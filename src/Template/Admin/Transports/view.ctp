        ...
        <div class="box box-info">
          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <td><?php if (isset($classes['country']['name'])) {
                    echo ucfirst($classes['country']['name']);
                  } else {
                    echo 'N/A';
                  } ?></td>
            </div>
            <div class="form-group">
              ...
              <?php if (isset($classes['state']['name'])) {
                echo ucfirst($classes['state']['name']);
              } else {
                echo 'N/A';
              } ?>
            </div>
            ...
            <div class="form-group">
              ...
              <?php if (isset($classes['name'])) {
                echo ucfirst($classes['name']);
              } else {
                echo 'N/A';
              } ?>
            </div>
