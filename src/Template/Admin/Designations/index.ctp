...
<div class="manag-stu">
	 ...
	 <?php echo $this->Form->create('name',array('url'=>array('controller'=>'designations','action'=>'add'),'type'=>'file','class'=>'form-horizontal')); ?>
 ...
 <label>Name<span>*</span></label>
     <?php echo $this->Form->input('name',array('class'=>'form-control','placeholder'=>'Designation Name', 'id'=>'title','label' =>false,'required')); ?>
    </div>
    
     <div class="col-sm-6">
 <label>Department<span>*</span></label>
     <?php echo $this->Form->input('depart_id',array('class'=>'form-control','type'=>'select','empty'=>'Select Department ','options'=>$depart,'placeholder'=>'Designation Name', 'id'=>'title','label' =>false,'required')); ?>
    </div>
     </div>
    	      <div class="form-group">
             <div class="col-sm-12">
...
?>   
	...
	<div class="box">
		...
		foreach($classes as $work){ //pr($work);
//pr($work);
		?>
                <tr>
