...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Return/Renew Book Manager
    </h1>
    <ol class="breadcrumb">
      <li><a href="<?php echo ADMIN_URL; ?>dashboards"><i class="fa fa-home"></i>Home</a></li>
      <li><a href="<?php echo ADMIN_URL; ?>ReturnRenewBooks/index">Manage Return/Renew Book </a></li>
    </ol>
      ...
      <div class="col-xs-12">
        ...
        <div class="box">
          ...
          <script>
            ...
            //~ var ho=$('#holder-type-id').val();
            //~ //alert(ho);
            //~ if(ho==''){
            //~ alert("Please select holder type first");
            //~ $('#tags').val('');
            //~ }
          ...
          <div class="box-body">
            <div class="manag-stu">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <label>Acc. No.</label>
                  <?php echo $this->Form->input('asn_no', array('class' => 'form-control fine-amnt', 'placeholder' => 'Enter Acc. No.', 'label' => false)); ?>
                </div>
              </div>
  ...
  $(document).ready(function() {
    ...
    $("#TaskAdminCustomerForm").bind("submit", function(event) {
      ...
      $.ajax({
        ...
        url: "<?php echo ADMIN_URL; ?>ReturnRenewBooks/depositebooksearch",
