            ...
            <div class="col-md-12">
                <div class="box box-info">
                    ...
                    <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12" style="margin-bottom:15px;">
                                        ...
                                        <label class="radio-inline">
                                            <input type="radio" name="category" id="inlineRadio2" value="NORMAL" checked> NORMAL
                                        </label>
                                        <!-- <label class="radio-inline">
                                    ...
                                    if ($form_no[0] == "canvas") {
                                        if ($studentslast_insert['formno']) {
                                            $form_last_no = $studentslast_insert['formno'] + 1;
                                        } else {
                                            $form_last_no = 1001;
                                        }
                                    ?>
                                        ...
                                        <div class="col-md-4" id="frno">
                                            ...
                                            <?php echo $this->Form->input('formno', array('class' => 'form-control ', 'placeholder' => 'Form no.', 'autocomplete' => 'off', 'required', 'id' => 'frnofield', 'type' => 'text', 'label' => false, 'value' => $form_last_no, 'readonly')); ?>
                                            <input type="hidden" id="form_last_no" value="<?= $form_last_no ?>">
                                        </div>
                                    ...
                                    <?php } else { ?>
                                        <div class="col-md-4" id="frno">
                                            <label for="inputEmail3" class="control-label">Form No.<span style="color:red;">*</span></label>
                                            <?php echo $this->Form->input('formno', array('class' => 'form-control secrh-loc autoformnumber', 'value' => $fromnos, 'placeholder' => 'Form no.', 'autocomplete' => 'off', 'required', 'id' => 'frnofield', 'type' => 'text', 'label' => false)); ?>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-control" name="board_id" id="" required="required">
                                    ...
                                    <?php if ($enroll_without_fees == 0) { ?>
                                        <div class="col-md-4" id="srnosss">
                                            ...
                                            <?php $number = trim($studentsid['enroll']);
                                                $addst = $number + 1;
                                                $stdent = $addst;
                                                echo $this->Form->input('enroll', array('class' => 'form-control', 'placeholder' => 'Enrollnment', 'type' => 'text', 'id' => 'enroll', 'value' => $stdent, 'label' => false, 'readonly'));
                                            }  ?>
                                        </div>
                                    <?php } else { ?>
                                                ...
                                                $('.secrh-loc').bind('blur', function() {
                                                        ...
                                                        $.ajax({
                                                                ...
                                                                success: function(data) {
                                                                    ...
                                                                    if (data == 0) {
                                                                        $('#spinner').html(
                                                                            $('#fname').val(''); $('#mname').val(''); $('#lname').val(''); $('#mobile').val('');

                                                                            $('#h1').val(''); $('#f_name').val(''); $('#m_name').val('');

                                                                            $('#ady').val(''); $('#acy').val(''); $('#b1').val(''); $('#sms_mobile').val(''); $('#datepick1').val(''); $('#section-id').val(''); $('#addre').val(''); $('#house-id').val(''); $('#my_img').attr('src',
                                                                            ...
                                                                            var f_phone = ar1[25];
                                                                            $('#fphone').val(f_phone);
                                                                            $('#class-id').html($("<option></option>").attr("value", ksey3).text(valssue3));
                        ...
                        <div class="form-group add_stundaddmi2">
                            <div id="load2" style="display: none;"></div>
                            <div class="col-sm-4 col-xs-6">
                                <label for="inputEmail3" class="control-label">Pupil's First Name<span style="color:red;">*</span></label>
                                <?php echo $this->Form->input('fname', array('class' => 'form-control', 'placeholder' => 'First Name', 'required', 'id' => 'fname', 'label' => false)); ?>
                            </div>
                            <div class="col-sm-4 col-xs-6">
                                <label for="inputEmail3" class="control-label">Middle Name</label>
                                <?php echo $this->Form->input('middlename', array('class' => 'form-control', 'placeholder' => 'Middle Name', 'id' => 'mname', 'label' => false)); ?>
                            </div>
                            <div class="col-sm-4 col-xs-6">
                                <label for="inputEmail3" class="control-label">Last Name</label>
                                <?php echo $this->Form->input('lname', array('class' => 'form-control', 'placeholder' => 'Last Name', 'id' => 'lname', 'label' => false)); ?>
                            </div>
                            <div class="col-sm-4 col-xs-6">
                            ...
                            <div class="col-sm-4 col-xs-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <?php echo $this->Form->input('dob', array('class' => 'form-control data',  'placeholder' => 'Date Of Birth', 'id' => 'datepick1', 'label' => false, 'required')); ?>
                            ...
                            <!-- <div class="col-sm-4 col-xs-6">
                                ...
                                // echo $this->Form->input('previous_board', array('class' => 'form-control', 'value' => $applicanst['previous_board'], 'placeholder' => 'Previous Board', 'type' => 'select', 'options' => $arrt, 'id' => 'previous_board', 'label' => false, 'required')); 
                                ?>
                            </div> -->


                            <!-- <div class="col-sm-4 col-xs-6">
                                <label for="inputEmail3" class="control-label">School and Class last attended<span style="color:red;">*</span></label>
                                <?php // echo $this->Form->input('sch_class', array('class' => 'form-control', 'placeholder' => 'School and class last attended', 'id' => 'sch_class', 'label' => false, 'required')); 
                                ?>
                            </div> -->
                        ...
                        <fieldset>
                            ...
                            <div class="col-sm-4 col-xs-6">
                                ...
                                <div class="col-sm-4 col-xs-6">
                                    ...
                                    <select class="form-control" name="cast" style="width: 100%;" required="required">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                <div class="col-sm-4">
                                    ...
                                    <input type="text" class="form-control" maxlength="30" name="fathername" placeholder="Father Name" id="f_name" required="required">
                                </div>


                                <div class="col-sm-4">
                                    <label for="inputEmail3" class="control-label">Father Mobile No<span style="color:red;">*</span></label>
                                    <input type="text" class="form-control" name="f_phone" placeholder="Father Mobile No" id="fphone" required="required" onkeypress="return isNumber(event);" maxlength="10" minlength="10">
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <label for="inputEmail3" class="control-label">Father Occupation<span style="color:red;">*</span></label>
                                    <input type="text" class="form-control" name="f_occupation" placeholder="Father Occupation" id="foccupation" required="required">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="text" class="form-control" maxlength="30" name="mothername" placeholder="Mother Name" id="m_name">
                                </div>
                                ...
                                <!-- <div class="col-sm-4">
                                    ...
                                    <input type="text" class="form-control" name="m_occupation" placeholder="Mother Occupation" id="moccupation">
                                </div> -->
                                ...
                                <!-- <div class="col-sm-4">
                                    <label for="inputEmail3" class="control-label">Mother Aadhar Card No</label>
                                    <input type="text" class="form-control" name="m_aadhar" placeholder="Mother Aadhar Card No" id="mphone">
                                </div> -->


                                <!-- <div class="col-sm-4">
                                    <label for="inputEmail3" class="control-label">Mother PAN Card No</label>
                                    <input type="text" class="form-control" name="m_pan" placeholder="Mother PAN Card No" id="m_pan">
                                </div> -->


                                <!-- <div class="col-sm-4">
                                    <label for="inputEmail3" class="control-label">Mother Email</label>
                                    <input type="text" class="form-control" name="m_email" placeholder="Mother Email" id="m_email">
                                </div>
                                 -->

                                <!-- <div class="col-sm-4">
                                    <label for="inputEmail3" class="control-label">Mother Picture</label>
                                    <?php // echo $this->Form->input('mother_pic', array('class' => 'form-control', 'type' => 'file', 'id' => 'mother_pic', 'label' => false, 'accept' => 'image/*')); 
                                    ?>
                                </div> -->


                                <!-- <div class="col-sm-12">
                                    <label for="inputEmail3" class="control-label">Mother Office Address</label>
                                    <textarea class="form-control" rows="3" placeholder="Enter Mother Office Address ..." name="m_officeaddress" id="m_officeaddress"></textarea>
                                </div> -->
                            ...
                            <!-- <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <textarea class="form-control" rows="3" placeholder="Enter Residential Address ..." name="address" id="addre" required="required"></textarea>
                                </div>
                            </div> -->
