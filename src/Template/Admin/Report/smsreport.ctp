...
$(document).ready(function () {
  ...
  $("#TaskAdminCustomerForm").bind("submit", function (event) {
    ...
    $.ajax({
      ...
      url: "<?php echo ADMIN_URL ;?>report/sms_delivered_student_search",
...
<div class="row" >
  <div class="col-xs-12">
   ...
   <div class="box" >
    <div class="box-header">
      <i class="fa fa-search" aria-hidden="true"></i>
      <h3 class="box-title">SMS Delivery Students List</h3>
        </div>
        <!-- /.box-header -->
