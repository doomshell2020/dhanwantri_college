...
';
	...
	if($section_id2[0]!='' && !empty($section_id2)){
			...
			foreach($section_id2 as $keys=>$elements) {
				...
				$classmalssssseh=$this->Comman->findgendercountawsboth($element,$elements,$acedmic);
...
<b>Total Female:</b>&nbsp;'.$classfemaletotalh.'
	...
	$html.='<td style="text-align:right;" width="50%" align="right">&nbsp;&nbsp;
<b>Total Male:</b>&nbsp;'.$classmaletotalh.'&nbsp;
...
<b>Total Female:</b>&nbsp;'.$classfemaletotalh.'
	  ...
	  }else if(isset($class_id2) && !empty($class_id2)){
...
$counter=1;
	 ...
	 $classssr=$this->Comman->findclass($element);
			   ...
			   <td width="30%" ><b>'.$classssr['title']."-".$sectionssss['title'].'</b><br>';
    ...
    $html.='<td> <br>';
		 ...
		 $classmale=$this->Comman->findgendercounthouseaws("Male",$element,$elements,$hkey,$acedmic);
    $html.=$classmale;
     ...
     }   $html.='<table><tr><td><b>Total :-'; $html.=$tyu;
      $html.='</b></td></tr></table>
					  </td>
		  ...
		  $classfemale=$this->Comman->findgendercounthouseaws("Female",$element,$elements,$hkey,$acedmic);
     $html.=$classfemale;
    ...
    $html.='<table><tr><td><b>Total :-'; $html.=$tyu2; $html.='</b></td></tr></table>
				  </td>';
  ...
  $html.='</td></tr></table>';
      ...
      $html.='<td><br>';
					 ...
					 <td>&nbsp;</td>
					 <td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td></td>
					<td>';   $cla=$this->Comman->findgendercounthouse2aws($element,$elements,$hkey,$acedmic);
					...
					$html.=$cla;
					 ...
					 <td>&nbsp;</td>
					 <td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td></td>
					<td>';   $cla2=$this->Comman->findgendercounthouseaws("Male",$element,$elements,$hkey,$acedmic);
					$html.=$cla2;
					 $tyu3+=$cla2; $html.='</td>
					 </tr></table>';
					 ...
					 <td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td></td>
					<td>';
					   $cla3=$this->Comman->findgendercounthouseaws("Female",$element,$elements,$hkey,$acedmic);
					  $html.=$cla3;
					   $tyu3+=$cla3; $html.='</td>
					 </tr></table>';
					 } }  $html.='<table><tr><td><b>Total :-'; $html.=$tyu3; $html.='</b></td></tr></table>   </td>
	...
	$classssr=$this->Comman->findclass($element);
			   ...
			   <td width="30%" ><b>'.$classssr['title'].'</b><br>';
    ...
    $html.='<td> <br>';
		 ...
		 $classmale=$this->Comman->findgendercounthousewcaws("Male",$element,$hkey,$acedmic);
    $html.=$classmale;
     $classtotal +=$classmale;
     ...
     $html.='</td></tr></table>';
      ...
      $html.='</b></td></tr></table>
		  ...
		  $classfemale=$this->Comman->findgendercounthousewcaws("Female",$element,$hkey,$acedmic);
     $html.=$classfemale;
     $classtotal +=$classfemale;
          $tyu2 +=$classfemale;
  ...
  $html.='</td></tr></table>';
      ...
      $html.='<td><br>';
					 ...
					 <td>&nbsp;</td>
					 <td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td></td>
					<td>';   $cla=$this->Comman->findgendercounthouse2wcaws($element,$hkey,$acedmic);
					...
					$html.=$cla;
					 ...
					 <td>&nbsp;</td>
					 <td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td></td>
					<td>';   $cla2=$this->Comman->findgendercounthousewcaws("Male",$element,$hkey,$acedmic);
					$html.=$cla2;
					 $tyu3+=$cla2; $html.='</td>
					 </tr></table>';
					 } }else if($gender=='Female'){  foreach($houselist as $hkey=>$helement) {
					 ...
					 <td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td></td>
					<td>';
					   $cla3=$this->Comman->findgendercounthousewcaws("Female",$element,$hkey,$acedmic);
					  $html.=$cla3;
					   $tyu3+=$cla3; $html.='</td>
					 </tr></table>';
					 } }  $html.='<table><tr><td><b>Total :-'; $html.=$tyu3; $html.='</b></td></tr></table>   </td>
