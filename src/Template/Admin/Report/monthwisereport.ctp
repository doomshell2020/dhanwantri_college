...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-money"></i> Monthly Collection Summary
    </h1>
    <ol class="breadcrumb">
      <li><a href="<?php echo ADMIN_URL; ?>dashboards"><i class="fa fa-home"></i>Home</a></li>
      <li><a href="<?php echo ADMIN_URL; ?>report/dailyreport">Monthly Collection Summary</a></li>
    </ol>
  </section>
  <!-- Main content -->
              ...
              $(document).ready(function() {
                ...
                $("#feesexl").bind("submit", function(event) {
                  $.ajax({
                    ...
                    dataType: "html",
                    type: "POST",
                    url: "<?php echo ADMIN_URL; ?>report/searchdailyreport2",
                    beforeSend: function() {
            ...
            <div class="form-group mar_btminner">
              ...
              <script>
                $(function() {
                  ...
                  // Set default selected month as current month
                  var currentDate = new Date();
                  var formatted = $.datepicker.formatDate('yy-mm', currentDate);
                  $('#monthpicker').val(formatted);

                  // Always hide the day calendar
              ...
              <div class="col-sm-3">
                <label for="monthpicker" class="control-label">Select Month</label>
                <input type="text" id="monthpicker" name="selected_month" class="form-control" placeholder="Select Month" readonly>
              </div>
