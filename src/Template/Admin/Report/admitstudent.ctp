 <!-- Content Wrapper. Contains page content -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Student Admission Summary Report</h1>
           <ol class="breadcrumb">
 <li><a href="<?php echo ADMIN_URL;?>students/admitstudent"><i class="fa fa-thumbs-up"></i>Student Admission Summary Report</a></li>
...
$(document).ready(function () {
  $("#TaskAdminCustomerFormss").bind("submit", function (event) {
    $.ajax({
      ...
      type:"POST", 
     url:"<?php echo ADMIN_URL ;?>report/admitsearch",
...
<label for="inputEmail3" class="control-label">Paid Admission Date From<span style="color:red;">*</span></label>
<?php echo $this->Form->input('from',array('readonly'=>'readonly','autocomplete'=>'off','required'=>'required','class'=>'form-control txtDate','placeholder'=>'Admission From','label' =>false)); ?>
 ...
 <div class="col-md-2 col-sm-6"> 
 <label for="inputEmail3" class="control-label">Paid Admission Date To<span style="color:red;">*</span></label>
 <?php echo $this->Form->input('to',array('readonly'=>'readonly','autocomplete'=>'off','required'=>'required','class'=>'form-control txtDate1','placeholder'=>'Admission To','label' =>false)); ?>
     ...
     <div class="col-md-2 col-sm-6" >
      <label for="inputEmail3" class="control-label">Select Admission Year<span style="color:red;">*</span></label>
<select class="form-control" name="acedmicyear[]"  required="required" >
    ...
    <option value="2022-23" selected="selected" >2022-23</option>
  ...
  <?php } ?>
     ...
     <div class="col-md-3 col-sm-12 text-sm-center"  style="margin-top: 29px;">
