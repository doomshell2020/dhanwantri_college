...
$(document).ready(function () {
  $("#feesexl").bind("submit", function(event){
    $.ajax({
      ...
      dataType:"html", 
      type:"POST", 
     url:"<?php echo ADMIN_URL ;?>report/defaultersearchmonthly",
       beforeSend: function(){
...
<option   value="<?php echo $previous_year; ?>"><?php echo $previous_year; ?></option>
     ...
     <div class="col-sm-2" >
		  <label for="inputEmail3" class="control-label">Select Class</label>
	    	<?php echo $this->Form->input('class_id',array('class'=>'form-control','multiple'=>'multiple','id'=>'subjt','type'=>'select','empty'=>'Select Class','options'=>$classes,'label' =>false)); ?>  
		          </div>     
		          
	     <div class="col-sm-2" >
			   	
		  <label for="inputEmail3" class="control-label">Select Section</label>
	    	<?php echo $this->Form->input('section_id',array('class'=>'form-control','multiple'=>'multiple','options'=>$sectionslist,'id'=>'','empty'=>'Select Section','label' =>false)); ?>  
		          </div>   	   
		            <div class="col-sm-2" >
		 		<label for="inputEmail3" class="control-label">Tuition Fee<span style="color:red;">*</span></label>
	    	<?php  $quat=array('April'=>'April','May'=>'May','June'=>'June','July'=>'July','August'=>'August','September'=>'September','October'=>'October','November'=>'November','December'=>'December','January'=>'January','February'=>'February','March'=>'March'); echo $this->Form->input('quarter',array('class'=>'form-control','required'=>'required','options'=>$quat,'empty'=>'Select Month','label' =>false)); ?>  
		          </div>   	                      		                                  
		 <div class="col-sm-4" >                             		                         
   <label for="inputEmail3" class="control-label">&nbsp;</label><br>
  <span>&nbsp;&nbsp;&nbsp;&nbsp;<label class="checkbox-inline"><input id="radio1" name="mode" checked="checked" value="1"  type="checkbox"><b>Only Quater Defaulter</b></label></span>  <span>&nbsp;&nbsp;&nbsp;&nbsp;<label class="checkbox-inline"><input id="radio1" name="mode1"  value="1"  type="checkbox"><b>Only Pending Fee Defaulter</b></label></span> 
   <input type="submit" style="background-color:#00c0ef;width:100px !important; margin-left: -2px;" class="btn btn4 btn_pdf myscl-btn date" value="Submit">  
...
right: 46px;"  target="_blank" class="btn btn-info btn-sm pull-right" href="<?php echo ADMIN_URL ;?>report/user_defaulter"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Export PDF</a></td>
   ...
   -->
  <tr>
          <input type="submit" style="background-color:#00c0ef;width:100px !important; margin-left: 1px;" class="btn btn4 btn_pdf myscl-btn date inv" name="Invite" value="SEND SMS"> 
        </tr>
                <tr>
