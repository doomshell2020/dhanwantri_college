 <!-- Content Wrapper. Contains page content -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Student Registration Summary Report</h1>
           <ol class="breadcrumb">
 <li><a href="<?php echo ADMIN_URL;?>report/registrationsummary"><i class="fa fa-thumbs-up"></i>Student Registration Summary Report</a></li>
...
$(document).ready(function () {
  $("#TaskAdminCustomerFormss").bind("submit", function (event) {
    $.ajax({
      ...
      type:"POST", 
     url:"<?php echo ADMIN_URL ;?>report/registrationsearch",
...
<label for="inputEmail3" class="control-label">Registration Date From<span style="color:red;">*</span></label>
<?php echo $this->Form->input('from',array('readonly'=>'readonly','autocomplete'=>'off','required'=>'required','class'=>'form-control txtDate','placeholder'=>'Admission From','label' =>false)); ?>
 ...
 <div class="col-md-2 col-sm-4 col-xs-6"> 
 <label for="inputEmail3" class="control-label">Registration Date To<span style="color:red;">*</span></label>
