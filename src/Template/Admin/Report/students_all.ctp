          ...
          <div class="box-header">
                ...
                $(document).ready(function () {
                  $("#feesexl").bind("submit", function(event){
                    $.ajax({
                      ...
                      dataType:"html", 
                      type:"POST", 
                    url:"<?php echo ADMIN_URL ;?>report/defaultersearch",
                      beforeSend: function(){
            ...
            <div class="form-group student_all_fgroup">
                ...
                <div class="col-sm-2s col-sm-4" >
                  ...
                  <?php  $quat=array('Quater1'=>'Quater1','Quater2'=>'Quater2','Quater3'=>'Quater3','Quater4'=>'Quater4'); echo $this->Form->input('quarter',array('class'=>'form-control','required'=>'required','options'=>$quat,'empty'=>'Select Quater','label' =>false)); ?>  
                </div>
                <div class="col-sm-4" style="margin-top:14px;">   
                  <br>                          		                         
                  <label for="inputEmail3" class="control-label"></label>
                  <span style="margin-right:15px;"><label class="checkbox-inline"><input id="radio1" name="mode" checked="checked" value="1"  type="checkbox"><b>Only Quater Defaulter</b></label></span>   <span><label class="checkbox-inline"><input id="radio1" name="mode1"  value="1"  type="checkbox"><b>Only Pending Fee Defaulter</b></label></span> 
                </div>
                <div class="col-sm-4" style="margin-top:20px;">
                  <input type="submit" style="background-color:#00c0ef;color:#fff;width:100px !important; margin-left: -2px;" class="btn btn4 btn_pdf myscl-btn date" value="Submit">  
                </div>
            </div>
