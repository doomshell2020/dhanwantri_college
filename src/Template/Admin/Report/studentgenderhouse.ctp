...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
        <li><a href="<?php echo ADMIN_URL;?>report/studentgenderhouse"><i class="fa fa-home"></i>Home</a></li>
        <li><a href="<?php echo ADMIN_URL;?>report/studentgenderhouse">Gender House Report </a></li>
    </ol>
  </section>
  <!-- Main content -->
                ...
                $(document).ready(function () {
                  $("#feesexl").bind("submit", function (event) {
                    $.ajax({
                      ...
                      dataType:"html",
                      type:"POST",
                    url:"<?php echo ADMIN_URL ;?>report/searchstudentgenderhouse",
            ...
            <div class="form-group margin_btmcol">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12" >
                  ...
                  <div style="display:flex; align-items:center;">
                    <label style="margin-right:10px;"><input type="radio" name="gender" checked="checked" value="Both" style="vertical-align:-1px;"> Both</label>
                    <label style="margin-right:10px;"><input type="radio" name="gender" value="Male" style="vertical-align:-1px;"> Male</label>
                    <label style="margin-right:10px;"><input type="radio" name="gender" value="Female" style="vertical-align:-1px;"> Female</label>
                  </div>
                </div>
            </div>
