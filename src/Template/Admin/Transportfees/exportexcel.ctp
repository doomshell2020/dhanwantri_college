...
$objPHPExcel->setActiveSheetIndex(0)
  ...
  $objPHPExcel->getActiveSheet()->setCellValue('B' . $ii, $value['student']['enroll']);
  
  $objPHPExcel->getActiveSheet()->setCellValue('C' . $ii, ucfirst(strtolower($value['student']['fname'] . ' ' . $value['student']['middlename'] . ' ' . $value['student']['lname'])));

  $objPHPExcel->getActiveSheet()->setCellValue('D' . $ii, ucfirst(strtolower($value['student']['class']['title'])));

  $objPHPExcel->getActiveSheet()->setCellValue('E' . $ii, ucfirst(strtolower($value['student']['section']['title'])));
  ...
  $objPHPExcel->getActiveSheet()->setCellValue('L' . $ii, $value['acadamic_year']);
  // $objPHPExcel->getActiveSheet()->setCellValue('M' . $ii, $status);
  $objPHPExcel->getActiveSheet()->setCellValue('M' . $ii, date('Y-m-d', strtotime($findsubquater['created'])));  
