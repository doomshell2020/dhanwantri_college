               ...
               <div class="form-group">
                 <div class="col-sm-6" style="margin-right: 0px; margin-left: -12px;">
                   ...
                   <div class="col-sm-6" style="margin-right: 0px; margin-left: -12px;">
                     ...
                     <?php echo $this->Form->input('bill_no', array('class' => 'form-control', 'id' => 'title', 'label' => false, 'required')); ?>
                   </div>
                   ...
                   <div class="col-sm-6" style="margin-right: 0px;margin-left: -12px;">
                     ...
                     <?php echo $this->Form->input('bill_amount', array('class' => 'form-control', 'id' => 'title', 'maxlength' => '5', 'label' => false, 'required')); ?>
                   </div>
                   <div class="col-sm-6" style="margin-right: 0px;margin-left: 11px;">
                     <label>Paid On</label>
                     <div class="input-group">
               ...
               <div class="form-group" id="subscrip">
                 <div class="col-sm-6">
                   ...
                   <div class="col-sm-6">
                     ...
                     <?php echo $this->Form->input('subs_no', array('class' => 'form-control', 'id' => 'title', 'label' => false, 'required')); ?>
                   </div>
                   <div class="col-sm-6">
            ...
            <?php echo $this->Form->input('pvolissue', array('class' => 'form-control', 'maxlength' => '5', 'id' => 'title', 'label' => false)); ?> 
               ...
               <div class="form-group">
                 ...
                 <div class="col-sm-6" style="margin-right: 0px;margin-left: -12px;">
                   ...
                   <?php echo $this->Form->input('per_volume_cost', array('class' => 'form-control', 'required' => 'required', 'maxlength' => '15', 'id' => 'title', 'min' => 1, 'label' => false)); ?>
                 </div>
