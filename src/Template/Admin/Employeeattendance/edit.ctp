...
<div class="cont">
	<div class="modal-header">
        ...
        <h4 class="modal-title" id="modalLabel"><i class="fa fa-calendar"></i>
			Update Lecture  - <?php echo $weekname; ?>		</h4>
		<small>
...
<label for="inputEmail3" class="col-sm-2 control-label">Subject</label>
	...
	/*echo $this->Form->input('subject_id',array('class'=>'form-control','type'=>'select','empty'=>'Select Subject','options'=>$subject,'value'=>$e,'label' =>false,'required'));*/
 ...
 echo $this->Form->input('new_empid',array('class'=>'form-control','type'=>'select','empty'=>'Select Employee','options'=>$array,'required','value'=>$f, 'label' =>false)); ?>  
 <span class="msg<?php echo $c;?><?php echo $a;?><?php echo $b;?>" style="color:red;"></span>
   ...
   <div class="modal-footer">
        <button type="submit" id="sum" class="btn btn-primary pull-left">Update</button>		<button type="button" class="close1 btn btn-default cls" data-dismiss="modal">Close</button>   </div> <!-- /. modal-footer -->
</form>
    </div>        
