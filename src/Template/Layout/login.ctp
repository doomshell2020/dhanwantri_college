...
<head>
  ...
  <title>Dhanwantri Institute of Medical Science</title>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group has-feedback">
            <?php echo $this->Form->input('email', array('class' => 'form-control validate[required, custom[email]]', 'data-prompt-position' => 'topRight:-38,-15', 'type' => 'text', 'placeholder' => 'Email', 'id' => 'email', 'label' => false)); ?>
