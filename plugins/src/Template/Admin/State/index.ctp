...
<li><a href="#" class="active">Manage State</a></li>
...
<div class="manag-stu">
  <div class="form-group">
  		<?php echo $this->Form->create($state,array('url'=>array('controller'=>'state','action'=>'add'),
			...
			<?php echo $this->Form->input('c_id',array('class'=>'form-control','required', 'empty'=>'Select Country','type' => 'select','options'=>$Country,'id'=>'title','label' =>false)); ?>
		        ...
		        <div class="form-group">
		          ...
		          <div class="col-sm-10">
			<?php echo $this->Form->input('name',array('class'=>'form-control','placeholder'=>'State', 'id'=>'title','required','label' =>false)); ?>
