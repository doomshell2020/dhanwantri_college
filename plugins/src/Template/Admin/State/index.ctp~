...
<?php echo $this->Flash->render(); ?>
  ...
  <td><?php if(isset($service['type'])){ if($service['type']=='0'){ echo "Pre";}else if($service['type']=='1'){ echo "Art"; }else if($service['type']=='2'){ echo "Commerce";}else{ echo "Science";} }else{ echo 'N/A';}?></td>
